<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TipoConv.aspx.vb" Inherits="Admin_catalogos_TipoConv" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
    <td align="right" class="auto-style1">Tipo de Convenio:</td><td colspan="2">
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvTiposC" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cTConvId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <asp:TemplateField ShowHeader="True" HeaderText="Eliminar">
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="cTConvId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cTConvId" runat="server" Text='<%# Eval("cTConvId")%>' Visible="false" ></asp:Label>
                  <%--<input  type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar" title="Ver" onclick="openph('<%# Eval("mUsuId") %>')" />                --%>
                  <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("mUsuId")%>' />  --%>   
