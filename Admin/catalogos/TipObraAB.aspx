<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipObraAB.aspx.vb" Inherits="Admin_catalogos_TipObraAB" %>
        ...
        <form id="form1" runat="server">
            <div>
                <table width="90%" align="center">
                    <tr>
                        <td colspan="4" align="center" class="style9"><strong>TIPO DE OBRA</strong></td>
                    </tr>
                    <tr>
                        <td class="style8"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="style7">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"
                                ControlToValidate="txtTipo" ErrorMessage="Introduzca tipo de obra" ForeColor="Red">
