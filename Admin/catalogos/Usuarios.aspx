<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Usuarios.aspx.vb"
    Inherits="Admin_catalogos_Usuarios" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style6">Nombre:</td>
                <td colspan="2">
                    <asp:TextBox ID="txtBuscar" runat="server" Width="250px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right" class="style7">Rol:</td>
            ...
            <tr>
                <td align="center" colspan="2">
                    ...
                    <%--<asp:HyperLink ID="lnkAgregar" runat="server" NavigateUrl="~/catalogos/UsuariosA.aspx">Agregar
                        </asp:HyperLink>--%>
                </td>
                <td align="left">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvUsuarios" runat="server" CellPadding="4" ForeColor="#FFFFCC" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="mUsuId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="mUsuId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="mUsuId" runat="server" Text='<%# Eval("mUsuId")%>' Visible="false">
                                    </asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="mUsuId" Visible="False" SortExpression="mUsuId"
                                HeaderText="mUsuId" />
