<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Modulos.aspx.vb"
    Inherits="Admin_catalogos_Modulos" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style7">Módulo:</td>
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvModulos" runat="server" CellPadding="4" ForeColor="#FFFFCC" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cModId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="False" HeaderText="IdModulo">
                                <ItemTemplate>
                                    <asp:Label ID="cModId" runat="server" Text='<%# Eval("cModId")%>' Visible="true">
                                    </asp:Label>
