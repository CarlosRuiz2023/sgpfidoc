<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="EstatusSol.aspx.vb" Inherits="Admin_catalogos_EstatusSol" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style6">Estatus:</td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvEstatus" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cEstId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="cEstId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="cEstId" runat="server" Text='<%# Eval("cEstId")%>' Visible="false">
                                    </asp:Label>
