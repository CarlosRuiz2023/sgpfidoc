<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EstatusSol.aspx.vb" Inherits="Admin_catalogos_EstatusSol" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="JavaScript">
        function openph(img) {
            //alert(img);
            var url1 = "EstatusSolAB.aspx?ResponseType=Edit&id=" + img;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
    <tr>
    <td colspan="3" align="center">ESTATUS DE SOLICITUDES</td>
    </tr>
    <tr>
    <td class="style6"></td>
    </tr>
    <tr>
    <td align="right" class="style6">Estatus:</td><td colspan="2">
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvEstatus" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cEstId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <asp:TemplateField ShowHeader="True" HeaderText="Modificar" >
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="cEstId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cEstId" runat="server" Text='<%# Eval("cEstId")%>' Visible="false" ></asp:Label>
                  
                                  
                  </ItemTemplate>                  
                    <ItemStyle HorizontalAlign="Center" />
                </asp:TemplateField>
                <asp:BoundField DataField="cEstId" Visible="False" SortExpression="cEstId" 
                    HeaderText="cEstId" />
                <asp:BoundField HeaderText="Nombre" DataField="cEstDescripcion" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
