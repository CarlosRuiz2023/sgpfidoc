<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="TipoUSuelo.aspx.vb" Inherits="Admin_catalogos_TipoUSuelo" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style6">Tipo de Uso de Suelo:</td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvTiposS" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cTUSueId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="cTUSueId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="cTUSueId" runat="server" Text='<%# Eval("cTUSueId")%>'
