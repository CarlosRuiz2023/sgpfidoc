<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TipoUSuelo.aspx.vb" Inherits="Admin_catalogos_TipoUSuelo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript" language="JavaScript">
        function openph(img) {
            //alert(img);
            var url1 = "TipoUSueloAB.aspx?ResponseType=Edit&id=" + img;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <table width="100%">
    <tr>
    <td colspan="3" align="center"><strong>TIPO DE USO DE SUELO</strong></td>
    </tr>
    <tr>
    <td class="style6"></td>
    </tr>
    <tr>
    <td align="right" class="style6">Tipo de Uso de Suelo:</td><td colspan="2">
        <asp:DropDownList ID="cmbTUSuelo" runat="server">
        </asp:DropDownList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvTiposS" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cTUSueId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <%--<asp:HyperLinkField DataNavigateUrlFormatString="~/Catalogos/UsuariosAB.aspx?id={0}" 
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="cTUSueId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cTUSueId" runat="server" Text='<%# Eval("cTUSueId")%>' Visible="false" ></asp:Label>
                  <%--<input  type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar" title="Ver" onclick="openph('<%# Eval("mUsuId") %>')" />                --%>
                  <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("mUsuId")%>' />  --%>   
                ...
                <asp:BoundField DataField="cTUSueId" Visible="False" SortExpression="cTUSueId" 
                    HeaderText="cTUSueId" />
                <asp:BoundField DataField="cTUSueIni" HeaderText="Iniciales">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField HeaderText="Nombre" DataField="cTUSueNombre" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
