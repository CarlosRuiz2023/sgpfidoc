...
<body>
    ...
    <table width="90%" align="center">
        ...
        <td align="right" style="width: 255px"> 
            <br />
            <span style="color:Red">*</span> No. Empleado:</td>
        <td colspan="3">
        ...
        <td colspan="3">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="txtNombre" ErrorMessage="Introduce el nombre" 
        ...
        <td align="right" style="width: 255px">
            <br />
            <span style="color:Red">*</span> Correo electrónico:</td>
        <td colspan="3" style="margin-left: 40px">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                ControlToValidate="txtCorreo" ErrorMessage="Introduce el correo" 
                ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            <asp:TextBox ID="txtCorreo" runat="server" Width="284px"></asp:TextBox>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                    ControlToValidate="txtCorreo" ErrorMessage="Correo Inválido" 
                    SetFocusOnError="True" 
        ...
        <td align="right" class="style6">
            <br />
            <span style="color:Red">*</span> Cuenta de usuario:</td>
        <td colspan="3" class="style7">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                ControlToValidate="txtUsuario" ErrorMessage="Introduzca usuario" 
                ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
        ...
        <td colspan="3">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                ControlToValidate="txtPass" ErrorMessage="Introduzca contraseña" 
        ...
        <td colspan="3">
            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                ...
                ErrorMessage="Las contraseñas no son idénticas" ForeColor="Red" SetFocusOnError="True"></asp:CompareValidator>
            </td>
        </tr>
        <tr>
        <td align="right" style="width: 255px">
            <span style="color:Red">*</span> Rol:</td>
        <td colspan="3">
        ...
        <tr>
        <td align="right" style="width: 255px">
            <span style="color:Red">*</span> Estatus:</td>
        <td colspan="3">
