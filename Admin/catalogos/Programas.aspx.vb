...
Partial Class Admin_catalogos_Programas
    ...
    Private Sub CargarDatos()
        ...
        cmbProgramas.DataSource = clsProgramas.Consulta_Estatus(objProgramas)
        cmbProgramas.DataValueField = "cProgId"
        cmbProgramas.DataTextField = "cProgNombre"
        cmbProgramas.DataBind()

        cmbProgramas.Items.Insert(0, objList)

        grvProgramas.DataSource = clsProgramas.Consulta_Estatus(objProgramas)
    ...
    Protected Sub btnBuscar2_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnBuscar2.Click
        ...
        objProgramas.IdPrograma = cmbProgramas.SelectedValue
