<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Poligono.aspx.vb" Inherits="Admin_catalogos_Poligono" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
    <td align="right" class="auto-style1">NOMBRE DEL POLIGONO:</td><td colspan="2" class="auto-style2">
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvPoligono" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cIdPoligono" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <%--<asp:HyperLinkField DataNavigateUrlFormatString="~/Catalogos/UsuariosAB.aspx?id={0}" 
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="IdPoligono" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cIdPoligono" runat="server" Text='<%# Eval("cIdPoligono")%>' Visible="false" ></asp:Label>
                  <%--<input  type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar" title="Ver" onclick="openph('<%# Eval("mUsuId") %>')" />                --%>
                  <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("mUsuId")%>' />  --%>   
