...
Partial Class Admin_catalogos_TipoPavimentoE
    ...
    Protected Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        ...
        Try
        objTipoPavimento.Eliminar = "ELIMINADO"
        
        If vId <> 0 Then
            objTipoPavimento.TipoPavId = vId
            'objEstatus.Estatus = dt.Rows(0).Item(1)
            objTipoPavimento.Accion = "Eliminar"
        End If
        
        ban = clsTipoPavimento.EliminarLogico(objTipoPavimento)
        If ban >= 0 Then
            'Limpiar()
