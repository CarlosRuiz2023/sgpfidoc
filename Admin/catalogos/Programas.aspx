<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Programas.aspx.vb" Inherits="Admin_catalogos_Programas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
    <td align="right" class="style6">Programa:</td><td colspan="2">
    ...
    <td colspan="3">
        <asp:GridView ID="grvProgramas" runat="server" CellPadding="4" ForeColor="#333333" 
            ...
            DataKeyNames="cProgId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <asp:TemplateField ShowHeader="True" HeaderText="Eliminar">
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="cProgId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cProgId" runat="server" Text='<%# Eval("cProgId")%>' Visible="false" ></asp:Label>
