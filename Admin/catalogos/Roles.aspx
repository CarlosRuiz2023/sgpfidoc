<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Roles.aspx.vb"
    Inherits="Admin_catalogos_Roles" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvRoles" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cRolId" style="margin-top: 0px"
                        HorizontalAlign="Center" CssClass="mGrid" PagerStyle-CssClass="pgr"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="cRolId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="cRolId" runat="server" Text='<%# Eval("cRolId")%>' Visible="false">
                                    </asp:Label>
