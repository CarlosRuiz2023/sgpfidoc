<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TipObra.aspx.vb"
    Inherits="Admin_catalogos_TipObra" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style6">Tipo de Obra:</td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvTiposO" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cTipOId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="cTipOId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="cProgId" runat="server" Text='<%# Eval("cTipOId")%>' Visible="false">
                                    </asp:Label>
                                    <%--<input type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar"
                                        title="Ver" onclick="openph('<%# Eval(" mUsuId") %>')" /> --%>
                                        <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario"
