...
Partial Class Admin_catalogos_TipObra
    Inherits System.Web.UI.Page

    Public objUsuarioEN As New clsUsuarios
    Public objTipo As New clsTiposO
    ...
    Private Function Lee_Permisos()
        ...
        dt = objUsuarioEn.GetPermisos(Session("IDUSUARIO"), 15)
    ...
    Private Sub CargarDatos()
        ...
        cmbTiposO.DataSource = clsTiposO.Consulta_TiposO(objTipo)
        cmbTiposO.DataValueField = "cTipOId"
        cmbTiposO.DataTextField = "cTipONombre"
        cmbTiposO.DataBind()

        cmbTiposO.Items.Insert(0, objList)
        grvTiposO.DataSource = clsTiposO.Consulta_TiposO(objTipo)
        grvTiposO.DataBind()

        dt = clsTiposO.Consulta_TiposO(objTipo)
    ...
    Protected Sub imageButtonClick(sender As Object, e As EventArgs)
        ...
        grvTiposO.SelectedIndex = row.RowIndex

        Response.Redirect("~/catalogos/UsuariosA.aspx")

    End Sub

    Protected Sub grvProgramas_PageIndexChanging(sender As Object, e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles grvTiposO.PageIndexChanging
        grvTiposO.PageIndex = e.NewPageIndex
        grvTiposO.DataBind()
    End Sub
    ...
    Protected Sub btnBuscar2_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnBuscar2.Click
        ...
        objTipo.IdTipo = cmbTiposO.SelectedValue
    ...
    Private Sub grvProgramas_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grvTiposO.RowDataBound
        Dim permisos As DataTable
        Dim AccCons As Integer
        ...
        If (e.Row.RowType = DataControlRowType.DataRow) Then
            ...
            Dim usu As Label
            usu = CType(e.Row.Cells(0).FindControl("cProgId"), Label)
