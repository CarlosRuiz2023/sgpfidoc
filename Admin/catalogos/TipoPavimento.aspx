<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TipoPavimento.aspx.vb" Inherits="Admin_catalogos_TipoPavimento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
    <td align="right" class="auto-style1">Tipo de Terreno:</td><td colspan="2" class="style3">
        <asp:DropDownList ID="cmbTiposPav" runat="server" Height="16px" style="margin-right: 0px" Width="154px">
        </asp:DropDownList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvPavimento" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cTipoPavId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <%--<asp:HyperLinkField DataNavigateUrlFormatString="~/Catalogos/UsuariosAB.aspx?id={0}" 
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="TipoPavId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cTipoPavId" runat="server" Text='<%# Eval("cTipoPavId")%>' Visible="false" ></asp:Label>
                  <%--<input  type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar" title="Ver" onclick="openph('<%# Eval("mUsuId") %>')" />                --%>
                  <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("mUsuId")%>' />  --%>   
            ...
            <EmptyDataTemplate>
                <table cellspacing="0" cellpadding="4" style="color:#333333;width:100%;border-collapse:collapse;margin-top: 0px">
		            <tr style="color:White;background-color:#FF6600;font-weight:bold;">
			            <th scope="col">Tipo de Terreno</th><th scope="col">Etiqueta de Terreno</th>
		            </tr>
                </table>
