<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CallesColonias.aspx.vb"
    Inherits="Admin_catalogos_CallesColonias" %>
            ...
            <div>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:ImageButton ID="btnBuscar2" runat="server" TabIndex="1"
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:GridView ID="grvCalles" runat="server" CellPadding="4" ForeColor="#333333"
                                GridLines="None" Width="100%" AutoGenerateColumns="False" AllowSorting="True"
                                style="margin-top: 0px" AllowPaging="True" PageSize="20">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:TemplateField ShowHeader="false">
                                        <ItemTemplate>
                                            <asp:Label ID="SECFNO" runat="server" Text='<%# Eval("SECFNO")%>'
                                                Visible="false"></asp:Label>
                                            <asp:Label ID="SSCFNO" runat="server" Text='<%# Eval("SSCFNO")%>'
                                                Visible="false"></asp:Label>
                                            <asp:Label ID="CLACNO" runat="server" Text='<%# Eval("CLACNO")%>'
                                                Visible="false"></asp:Label>
                                            <asp:Label ID="idcalle" runat="server" Text='<%# Eval("CLACNO")%>'
                                                Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ShowHeader="True" HeaderText="Calle">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="calle" runat="server" Text='<%# Eval("NACCNO")%>'>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ShowHeader="True" HeaderText="Colonia">
                                        <ItemTemplate>
                                            <asp:Label ID="colonia" runat="server" Text='<%# Eval("NOMFNO")%>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ShowHeader="True" HeaderText="Calle anterior">
                                        <ItemTemplate>
                                            <asp:Label ID="callea" runat="server" Text='<%# Eval("NANCNO")%>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <EmptyDataTemplate>
                                    <table cellspacing="0" cellpadding="4" id="grvCalles"
