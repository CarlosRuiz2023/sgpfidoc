<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TRecursos.aspx.vb" Inherits="Admin_catalogos_TRecursos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="JavaScript">
        function openph(img) {
            //alert(img);
            var url1 = "TRecursoAB.aspx?ResponseType=Edit&id=" + img;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="100%">
    <tr>
    <td colspan="3" align="center"><strong>TIPO DE RECURSOS</strong></td>
    </tr>
    <tr>
    <td class="style6"></td>
    </tr>
    <tr>
    <td align="right" class="style6">Tipo de Recurso</td><td colspan="2">
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvProgramas" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cTRecId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <%--<asp:HyperLinkField DataNavigateUrlFormatString="~/Catalogos/UsuariosAB.aspx?id={0}" 
                 ...
                 <asp:TemplateField ShowHeader="false" HeaderText="cTRecId" Visible="False">
                  <ItemTemplate>   
                      <asp:Label ID="cTRecId" runat="server" Text='<%# Eval("cTRecId")%>' Visible="false" ></asp:Label>
                  <%--<input  type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar" title="Ver" onclick="openph('<%# Eval("mUsuId") %>')" />                --%>
                  <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("mUsuId")%>' />  --%>   
                ...
                <asp:BoundField DataField="cTRecId" Visible="False" SortExpression="cTRecId" 
                    HeaderText="cTRecId" />
                <asp:BoundField HeaderText="Nombre" DataField="cTRecNombre" >
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
