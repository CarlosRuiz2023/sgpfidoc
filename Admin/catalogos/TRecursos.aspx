<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="TRecursos.aspx.vb" Inherits="Admin_catalogos_TRecursos" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <table width="100%">
            ...
            <tr>
                <td align="right" class="style6">Tipo de Recurso</td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="3">
                    <asp:GridView ID="grvProgramas" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        Width="100%" AutoGenerateColumns="False" DataKeyNames="cTRecId" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="false" HeaderText="cTRecId" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="cTRecId" runat="server" Text='<%# Eval("cTRecId")%>' Visible="false">
                                    </asp:Label>
                                    <%--<input type="image" src="../../imagenes/eliminar_usuario.png" alt="Editar"
                                        title="Ver" onclick="openph('<%# Eval(" mUsuId") %>')" /> --%>
                                        <%-- <asp:ImageButton runat="server" ID="btnEliminar_Usuario"
