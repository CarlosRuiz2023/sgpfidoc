<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="OrigenSol.aspx.vb" Inherits="Admin_catalogos_OrigenSol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td align="right" class="style7">Origen:</td><td colspan="2" class="style1">
    ...
    <tr>
    <td colspan="3">
        <asp:GridView ID="grvOrigen" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None" Width="100%" AutoGenerateColumns="False" 
            DataKeyNames="cOrigId" AllowSorting="True" style="margin-top: 0px" 
            ...
            <Columns>
                ...
                <asp:TemplateField ShowHeader="True" HeaderText="Eliminar">
                  <ItemTemplate>   
                    <asp:ImageButton runat="server" ID="btnEliminar_Usuario" 
                        ImageUrl="~/Admin/imagenes/eliminar_usuario.png" BorderStyle="None" OnCommand="botones"  
                        CommandName="Eliminar" CommandArgument='<%# Eval("cOrigId")%>' OnClientClick="return confirm('¿Desea eliminar el registro?');" />    
               ...
               <asp:TemplateField ShowHeader="False" HeaderText="IdOrigen">
                  <ItemTemplate>   
                      <asp:Label ID="cOrigId" runat="server" Text='<%# Eval("cOrigId")%>' Visible="true" ></asp:Label>                  
