<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipoPavimentoAB.aspx.vb" Inherits="Admin_catalogos_TipoPavimentoAB" %>
...
<body style="height: 245px; width: 504px">
    ...
    <table align="center" style="width: 99%">
        ...
        <td colspan="3" class="auto-style38">
            ...
            <br />
            <asp:TextBox ID="txtTipoPavimento" runat="server" Height="25px" style="margin-bottom: 0px" Width="193px"></asp:TextBox>
            <br />
            </td>
        </tr>
        <tr>
    ...
    <td align="right" class="auto-style35">Fecha:</td><td colspan="3">
        ...
        <tr>
    <td align="right" class="auto-style35">Modifico:</td><td colspan="3">
