    ...
    <table width="90%" align="center">
        ...
        <td colspan="2">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="txtRol" ErrorMessage="Introduce el rol" 
        ...
        <td colspan="2" align="left"> 
       <asp:GridView ID="grvPermisos" runat="server" AutoGenerateColumns="False" OnRowDataBound="grvPermisos_RowDataBound" DataKeyNames="mModId" 
           CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Consultar" >
                        <ItemTemplate >
                            <asp:CheckBox ID="chkConsultar" runat="server" Checked='<%# Eval("mAccCons") %>' />
                        </ItemTemplate >
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Alta" >
                    <ItemTemplate>
                        <asp:CheckBox ID="chkAgregar" runat="server" Checked='<%# Eval("mAccAlta") %>' />
                    </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Eliminar">
                        <ItemTemplate>
                        <asp:CheckBox ID="chkBaja" runat="server" Checked='<%# Eval("mAccBaja") %>' />
                    </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Modificar">
                        <ItemTemplate>
                        <asp:CheckBox ID="chkMod" runat="server" Checked='<%# Eval("mAccMod") %>' />
                    </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Administrar">
                        <ItemTemplate>
                        <asp:CheckBox ID="chkAdmon" runat="server" Checked='<%# Eval("mAccAdmon") %>' />
                    </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
