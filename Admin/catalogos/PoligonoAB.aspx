                ...
                <table align="center" style="width: 97%">
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="auto-style38">
                            ...
                            <br />
                            <asp:TextBox ID="txtPoligono" runat="server" Height="25px" style="margin-bottom: 0px"
                    ...
                    <tr>
                        <td align="right" class="auto-style45">Origen del Polígono:</td>
                        <td colspan="3">
                            <asp:TextBox ID="txtOrigenGobierno" runat="server" Height="25px" style="margin-bottom: 0px"
                                Width="190px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style45">Num. de Registro:</td>
                        <td colspan="3" class="auto-style48">
                            <asp:TextBox ID="txtNumRegistro" runat="server" Height="25px" style="margin-bottom: 0px"
                                Width="193px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style47"></td>
                        <td colspan="3" class="auto-style51">
                        </td>
                    </tr>
                    <tr>
                        <td align="right" class="auto-style48">Capturo:</td>
                        <td colspan="3" class="auto-style48">
                    ...
                    <tr>
                        <td align="right" class="auto-style48">Fecha:</td>
                        <td colspan="3" class="auto-style48">
                    ...
                    <tr>
                        <td align="right" class="auto-style48">Modifico:</td>
                        <td colspan="3" class="auto-style48">
