<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TipoPavimentoE.aspx.vb"
    Inherits="Admin_catalogos_TipoPavimentoE" %>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="auto-style2">
                            ...
                            <asp:TextBox ID="txtTipoPavimento" runat="server" Height="25px" style="margin-bottom: 0px"
                                Width="193px" Enabled="False"></asp:TextBox>
                            <br />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="3">
                            <br />
                            <asp:TextBox ID="txtTipoPavRom" runat="server" Height="28px" Width="197px" Enabled="False">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
