<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_coop_cv.aspx.vb"
    Inherits="Admin_procesos_consultar_coop_cv" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <label>Nombre del Cooperador:</label><input type="text" name="nombre" id="txtnom_coop" style="width:250px"
                maxlength="120" /><br /><br />
            <label>Coop_SIFIDOC:</label><input type="text" name="coop_sifidoc" id="txtcoop_sifidoc" style="width:100px"
                maxlength="13" /><br /><br />
            <label>CTA. PREDIAL:</label><input type="text" name="ctapredial" id="txtctapredial" style="width:100px"
