<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="solicitudes_asambleas.aspx.vb" Inherits="Admin_procesos_solicitudes_asambleas" %>
 ...
 <div id="boxes">        
    <div id="dialogopresup" class="window"> 
       ...
       <div class="datos" id="bodypresup">        
          ...
          <label for="name">*Folio:</label><input type="text" name="folio" id="txtfolio" size="10"/><br/><br/>  
          <label for="name">Mts_Sección:</label><input type="text" name="mtsseccion" id="txtmtsseccion" size="10"/><br/><br/>
          <label for="name">Mts_Banqueta:</label><input type="text" name="mtsbanqueta" id="txtmtsbanqueta" size="10"/><br/><br/>
          <label for="name">Mts_Arroyo:</label><input type="text" name="mtsarroyo" id="txtmtsarroyo" size="10"/><br/><br/>
          <label for="name">Gastos Admvos.:</label><input type="text" name="gastosadmvos" id="txtgastosadmvos" size="10"/><br/><br/>
          ...
          <label for="name">Estatus presup.:</label><input type="text" name="estatuspresup" id="txtestatuspresup" size="2"/><br/><br/>          
          <label for="name">*Documento:</label><input type="file" id="filepresup" name="file"/> <a href="#" id="archivo" class="verarchivo"/>                    
       </div>                  
