<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_calle_du.aspx.vb" Inherits="Admin_procesos_consultar_calle_du" %>
...
<label>Nombre de Calle:</label><input type="text" name="nom_calle" id="txtnomcalle" style="width:250px" maxlength ="30"/><br/><br/>
<label>Nombre Anterior de Calle:</label><input type="text" name="nom_calle_anterior" id="txtnomcalle_ant" style="width:250px" maxlength="30"/><br/><br/>
<label>Nombre Colonia:</label><input type="text" name="nom_colonia" id="txtnom_colonia" style="width:250px" maxlength="30"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_calle"><== Buscar Nombre(s) ==></a><br/><br/>
