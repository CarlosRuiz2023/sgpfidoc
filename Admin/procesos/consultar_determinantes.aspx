<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_determinantes.aspx.vb" Inherits="Admin_procesos_consultar_determinantes" %>
                        ...
                        $("#grid").jqGrid(
                            {
                                ...
                                colModel: [
                                    ...
                                    {
                                        index: 'saldo_sin', width: 100, align: 'Center', name: 'saldo_sin'
                                    },
                                    {
                                        index: 'saldo_sin_act', width: 100, align: 'Center', name: 'saldo_sin_act'
                                    },
                                    {
                                ...
                                width: "2500",
                                height: "800",
                                caption: "COOPERADORES PARA DETERMINAR"
                            ...
                            .navButtonAdd('#pager',
                                {
                                    ...
                                    onClickButton: function () {
                                        ...
                                        if (accion_coop_det == 1) {
                                            ...
                                            if (objCoop.iddcto > 0 && objCoop.det_estatus == 2) {  /*Si la carta a actualizarle la fecha de impresion esta notificada */
                                                accion_gestion = 0;/*No se puede realizar la actualización debido a que la carta seleccionada emitida esta notificada*/
                                            }
                                            else {
                                                accion_gestion = 2; /*Se actualiza la carta de término*/
                                            }
                                        }
                                        ...
                                        var objGestionPAE = {
                                            ...
                                            "obs_det": 'Genera Carta Termino de Obra: ' + hoy,
                                        ...
                                        if (objCoop.fid) {
                                            if (accion_gestion > 0) { /*Valida que se pueda llevar a cabo el registro (accion_gestion= 1) o la actualización (accion_gestion==2) de la carta de término*/
                                                RegistraGestionPAE(objGestionPAE)  /*Registro de Carta de Termno de Obra*/
                                                    .done(function (r) {
                                                        var resp = r.d;
                                                        GeneraDctoCartaTermino(objCoop);
                                                        alert('Carta de término de obra ha sido generado');
                                                        $('#mask, .window').hide();
                                                        RedibujarGrid();
                                                    })
                                                    .fail(function (xhr) {
                                                        console.log(xhr.responseText);
                                                        alert("No fué posible registrar la carta de término de obra...");
                                                    });
                                            }
                                            else {
                                                alert('La carta de terminación de obra, se encuentra NOTIFICADA, por lo tanto no es posible actualizar la fecha de impresión o de creación del documento')
                                            }
                                        }
                                        else {
                                            alert("Selecciona un cooperador...");
                            ...
                            .navButtonAdd('#pager',
                                {
                                    ...
                                    onClickButton: function () {
                                        ...
                                        $("#lblfid_termobr").html(objCoop.fid);
                                        $("#lblcoop_s_termobr").html(objCoop.O_SIFIDOC + objCoop.COOP_SIFIDOC);
                                        $("#lblfecimp_termobr").html(objCoop.FecImpDcto);
                                        $("#lbliddcto_termobr").html(objCoop.iddcto);
                                        if (accion_coop_det == 2) {
                                            $("#lblaccion_gestion_termobr").html(3);
                                        }
                                        else { /*Cuando se escogio la ocpion 3*/
                                            $("#lblaccion_gestion_termobr").html(4);
                                        }

                                        $("#txtfec_notif_term_obr").val(objCoop.FecNotifDcto);
                                        $("#file_ref_obrterm").text(objCoop.nom_doc);

                                        if (objCoop.fid) {
                                            llenarMinistros2(objCoop.idministro)
                                            MostrarModalNotifTermObra();
                                        }
                                        else {
                                            alert("Selecciona un cooperador...");
                                        }
                            ...
                            .navButtonAdd('#pager',
                                {
                                    ...
                                    onClickButton: function () {
                                        ...
                                        if (accion_coop_det == 3) {
                                            ...
                                            if (objCoop.iddcto > 0 && objCoop.det_estatus == 2) {  /*Si el determinante esta entregado */
                                                accion_gestion = 0;/*No se puede realizar la actualización del determinante debido a que ya se encuentra entregado al ministro*/
                                            }
                                            else {
                                                accion_gestion = 6; /*Se actualiza la carta de término*/
                                            }
                                        }
                            ...
                            .navButtonAdd('#pager',
                                {
                                    ...
                                    onClickButton: function () {
                                        ...
                                        $("#lblfid_dcto").html(objCoop.fid);
                                        $("#lblcoop_s_dcto").html(objCoop.O_SIFIDOC + objCoop.COOP_SIFIDOC);
                                        $("#lblfec_imp_doc").html(objCoop.FecImpDcto);
                                        $("#lbliddcto").html(objCoop.iddcto);
                                        if (accion_coop_det == 4) {
                                            $("#lblaccionentdoc").html(7);
                                        }
                                        else { /*Cuando se escogio la ocpion 5*/
                                            $("#lblaccionentdoc").html(8);
                                            $("#txtfecentdcto").val(objCoop.FecEntDcto);
                                        }

                                        if (objCoop.fid) {
                                            llenarMinistros(objCoop.idministro)
                                            MostrarModalEntDcto();
                                        }
                                        else {
                                            alert("Selecciona un cooperador...");
                            ...
                            .navButtonAdd('#pager',
                                {
                                    ...
                                    onClickButton: function () {
                                        ...
                                        $("#lblfid_notifdcto").html(objCoop.fid);
                                        $("#lblcoop_s_notifdcto").html(objCoop.O_SIFIDOC + objCoop.COOP_SIFIDOC);
                                        $("#lblfecentdcto2").html(objCoop.FecEntDcto);
                                        $("#lbliddcto_notif").html(objCoop.iddcto);
                                        $("#lblidministro_dcto_notif").html(objCoop.idministro);
                                        $("#chkam").prop('checked', 1);
                                        $("#chkpm").prop('checked', 0);

                                        if (accion_coop_det == 5) {
                                            $("#lblaccion_notifdcto").html(9);
                                        }
                                        else { /*Cuando se escogio la ocpion 6*/
                                            $("#lblaccion_notifdcto").html(10);
                                            $("#txtfecnotifdcto").val(objCoop.FecNotifDcto);
                                            $("#archivo_dctonotif").text(objCoop.nom_doc);
                                        }

                                        if (objCoop.fid) {
                                            MostrarModaNotifDcto();
                                        }
                                        else {
                                            alert("Selecciona un cooperador...");
                                        }
            ...
            <div id="boxes">
                <div id="dialogotermobr" class="window">
                    ...
                    <div class="datos" id="bodytermobr">
                        <label for="name" id="Label8">*Fecha de Notificación de la CARTA DE CONCLUSION:</label><input
                            type="text" name="fecnotidtermobr" id="txtfec_notif_term_obr" size="10"
                            onkeyup="this.value=formateafecha(this.value);" /><br /><br />
                        <label for="name" id="Label9">*MINISTRO:</label><select name="ministros"
                            id="lstministros2"></select><br /><br />
                        <input type="file" name="doc_termobr" id="file_termobr" />&nbsp&nbsp<a href="#"
                            id="file_ref_obrterm" class="verarchivo_obrterm"></a><br /><br />
                    </div>
                    <div class="botonesA" id="botonestermobr">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_notiftermobr">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_notiftermobr">Cancelar</a></p>
                    </div>
                </div>
                <div id="dialogoentdcto" class="window">
                    ...
                    <div class="datos" id="bodyentdcto">
                        <label for="name" id="lblfecentdcto">*Fecha de Entrega del DETERMINANTE:</label><input
                            type="text" name="fecentdcto" id="txtfecentdcto" size="10"
                            onkeyup="this.value=formateafecha(this.value);" /><br /><br />
                        <label for="name" id="lblministros">*MINISTRO:</label><select name="ministros"
                            id="lstministros"></select><br /><br />

                    </div>
                    <div class="botonesA" id="botonesentdcto">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_entdcto">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_entdcto">Cancelar</a></p>
                    </div>
                </div>
                <div id="dialogonotifdcto" class="window">
                    ...
                    <div class="datos" id="bodynotifdcto">
                        <label for="name" id="lblnotifdcto">*Fecha de Notificación del DETERMINANTE:</label><input
                            type="text" name="fecnotifdcto" id="txtfecnotifdcto" size="10"
                            onkeyup="this.value=formateafecha(this.value); maxlength=10" /><br /><br />
                        <label for="name" id="lblhoranotifdcto">*Hora de Notificación del DETERMINANTE:</label><input
                            type="text" name="horanotifdcto" id="txthorafecnotif" size="5"
                            onkeyup="this.value=formateahora(this.value); maxlength=5" /><label><input type="checkbox"
                                id="chkam" name="am" />a.m.</label><label><input type="checkbox" id="chkpm"
                                name="pm" />p.m.</label><br /><br />
                        <input type="file" name="dcto_dotif" id="doc_notif" /><a href="#" id="archivo_dctonotif"
                            class="verarchivo_dctonotif" /><br /><br />
                    </div>
                    <div class="botonesA" id="botonesnotifdcto">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_notifdcto">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_notifdcto">Cancelar</a></p>
                    </div>
                </div>
