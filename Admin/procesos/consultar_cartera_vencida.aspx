<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_cartera_vencida.aspx.vb" Inherits="Admin_procesos_consultar_cartera_vencida" %>
...
<label>Nombre de COOPERADOR:</label><input type="text" name="calle" id="txtnomcoop" style="width:250px" maxlength ="120"/><br/><br/>        
<label>CTA_PREDIAL:</label><input type="text" name="calle" id="txtctapredial" style="width:250px" maxlength ="120"/><br/><br/>        
<label>Clave Cooperador (SIFIDOC):</label><input type="text" name="obr_clv_int" id="txtclvcoop_s" style="width:250px" maxlength ="13"/><br/><br/>        
<label>Clave Frente (SGPFIDOC):</label><input type="text" name="obra" id="txtclvcoop_sgp" style="width:250px" maxlength="10"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_coop_cv"><== Buscar Cooperador ==></a><br/><br/>
