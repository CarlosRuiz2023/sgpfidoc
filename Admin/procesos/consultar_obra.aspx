<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_obra.aspx.vb"
    Inherits="Admin_procesos_consultar_obra" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
                        ...
                        .navButtonAdd('#pager',
                            {
                                ...
                                onClickButton: function () {
                                    ...
                                    if (parseInt(objObra.ClvObra) > 0) {
                                        //parseInt(objObra.obr_estatus) == 2 || parseInt(objObra.obr_estatus) == 4
                                        if (true) {
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <label>Nombre de Calle:</label><input type="text" name="calle" id="txtnomcalle" style="width:250px"
                maxlength="120" /><br /><br />
            <label>ClvObra (SGPFIDOC):</label><input type="text" name="obr_clv_int" id="txtclvsgp" style="width:250px"
                maxlength="10" /><br /><br />
            <label>Obra (SIFIDOC):</label><input type="text" name="obra" id="txtnumobra" style="width:250px"
            ...
            <div id="boxes">
                <div id="dialogoobraS" class="window">
                    ...
                    <div class="datos" id="bodyobraS">
                        <br />
                        <br />
                        <label for="name" id="lblubic">*OID:</label><select name="ubicobra" id="lstubicobra"
                            onchange="consulta_oid(this.value)"></select><br /><br />
                        ...
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbltramolim1">*Limite 1
                            del TRAMO:</label><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbltramolim2">*Limite 2
                            del TRAMO:</label><br /><br />


                        <label for="name" id="lbltipoobra">*Tipo de Obra:</label><select name="tipoobra"
                            id="lsttipoobra"></select><br /><br />
                        <label for="name" id="lblprograma">*Programa (SGPFIDOC):</label><select name="programa"
                            id="lstprograma"></select><br /><br />
                        <label for="name">*Costo x Mto. Lineal:</label><input type="text" name="costoxmto"
                            id="txtcostoxmto" class="numbersOnly" size="6" maxlength="8" /><br /><br />
                        <label for="name" id="lblfecinipag">*Fecha de Inicio de Pagos (dd/mm/aaaa):</label><input
                            type="text" name="fecinipag" id="txtfecinipag" size="10" maxlength="10"
                            onkeyup="this.value=formateafecha(this.value);"
                            onblur="FechaVencPagos(txtnumpag.value)" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label
                            for="name" id="lblnumpagos">*Número de Pagos:</label><input type="text" size="6"
                            maxlength="5" id="txtnumpag" name="numpag"
                            onkeyup="FechaVencPagos(this.value)" /><br /><br />
                        <label for="name" id="llfecven1">Fecha de vencimiento de pagos (dd/mm/aaaa):</label><label
                            for="name" id="lblfecvenc"></label><br /><br />
                    ...
                    <table class="t_modulo">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="e"><input class="dato_captura" type="text" name="feciniproc"
                                        id="txtfeciniproc" size="10" maxlength="10"
                                        onkeyup="this.value=formateafecha(this.value);" /></td>
                            </tr>
                            <tr>
                                <td class="f">*Gastos Administrativos:</td>
                                <td class="e" colspan="2"><input class="dato_captura_float" type="text"
                                        name="gastos_admvos" id="txtgastos_admvos" size="10" maxlength="10" /></td>
                                <td class="f">*Tipo Recurso:</td>
                                <td class="e" colspan="2"><select class="select_captura" name="tipo_recurso"
                                        id="lsttipo_recurso"></select></td>
                            </tr>
                            <tr>
                                <td class="f" colspan="2">*No. Contrato:</td>
                                <td colspan="2"><select class="select_captura" name="num_contrato"
                                        id="lstcontratos"></select></td>
                            ...
                            <tr>
                                <td colspan="3" class="boton_dialog"><a href="#"
                                        class="posicion_boton_accion_obra_proc">ACEPTAR</a></td>
                                <td colspan="3" class="boton_dialog"><a href="#"
                                        class="posicion_boton_cancelar_obra_proc">CANCELAR</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div id="dialogoobrajur1" class="window">
                    ...
                    <div class="datos" id="bodyObra_jur1">
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur1">*Fecha de Publicación 1:</label><input
                            type="text" name="fecpub1" id="txtfecpub1" size="10" maxlength="10"
                            onkeyup="this.value=formateafecha(this.value);" /><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur2">*Evidencia de Publicación
                            1:</label><input type="file" name="evidpub1" id="evidpub1" />&nbsp&nbsp<a href="#"
                            id="file_evidpub1" class="verarchivo_file_evidpub1"></a><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur3">*Fecha de Publicación 2:</label><input
                            type="text" name="fecpub2" id="txtfecpub2" size="10" maxlength="10"
                            onkeyup="this.value=formateafecha(this.value);" /><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur4">*Evidencia de Publicación
                            2:</label><input type="file" name="evidpub2" id="evidpub2" />&nbsp&nbsp<a href="#"
                            id="file_evidpub2" class="verarchivo_file_evidpub2"></a><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur5">*Costo de la Obra:</label><input
                            type="text" name="costo_obra" id="txtcosto_obra" size="15" maxlength="15"
                            class="numbersOnly" /><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp<label for="name" id="lbljur6">*Naturaleza de la
                            Obra:</label><br /><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkBanq"
                                name="Banquetas" />Banquetas y guarniciones.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkPav"
                                name="Pavimento" />Pavimento.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkAtarj"
                                name="Atarjea" />Atarjeas.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkRed"
                                name="Redes" />Instalación de redes de distribución.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkAlum"
                                name="Alumbrado" />Alumbrado público.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkDren"
                                name="Drenaje" />Instralación de drenaje.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkVias"
                                name="Vias" />Apertura de nuevas vías públicas.</label><br />
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label><input type="checkbox" id="chkJard"
                                name="Jardines" />Jardines y obras de equipamiento urbano.</label><br />
                    </div>
                    <div class="botonesA" id="botones_jur1">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_obra_jur1">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_obra_jur1">Cancelar</a></p>
                    </div>
                </div>
                <div id="dialogo_obrterm" class="window">
                    <table class="t_modulo">
                        <tbody>
                            <tr>
                                <td colspan="4" class="titulo_modulo">CAMBIAR ESTATUS DE PROCESO --> TERMINADA VENCIDA
                                </td>
                            </tr>
                            <tr>
                                <td class="f">CALLE:</td>
                            ...
                            <tr>
                                <td class="boton_dialog" colspan="2"><a href="#"
                                        class="posicion_boton_accion_obra_term">ACEPTAR</a></td>
                                <td class="boton_dialog" colspan="2"><a href="#"
                                        class="posicion_boton_cancelar_obra_term">CANCELAR</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div id="dialogofichapagomes" class="window">
                    ...
                    <div class="datos" id="body_fichapagomes">
                        Periodo de Recaudación:&nbsp&nbsp&nbsp<label for="fecinipag_x"
                            id="lblfecinipag_x"></label>&nbsp&nbsp&nbspde&nbsp&nbsp&nbsp<label for="fecfinpag_x"
                            id="lblfecfinpag_x"></label><br /><br />
                        No. de Pagos:&nbsp&nbsp&nbsp<label for="num_pagos" id="lblnumfichas_x"></label><br /><br />
                        Se genera ficha número:&nbsp&nbsp&nbsp<label for="numfichaactual"
                            id="lblnumfichaactual"></label>&nbsp&nbsp&nbspde&nbsp&nbsp&nbsp<label for="num_fichas"
                            id="lblnumfichas_y"></label><br /><br />
                    </div>
                    <div class="botonesA" id="botones_fichapagomes">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_ficha_pago_mes">Generar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_ficha_pago_mes">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
                <div id="rep_xls"></div>
