<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_comite.aspx.vb"
    Inherits="Admin_procesos_consultar_comite" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>No. Sesión:</label><input type="text" name="num_sesion" id="txtnum_sesion_q" style="width:250px"
            maxlength="6" onkeyup="this.value=formatea_num_sesion(this.value);" /><br /><br />
        <label>Fecha_Comite:</label><input type="text" name="fec_comite" id="txtfec_comite_q" size="10" maxlength="10"
            onkeyup="this.value=formateafecha(this.value);" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#"
            class="buscar_comite">
            <== Buscar COMITE TECNICO==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_comite">
            <== Alta COMITE TECNICO==>
        </a><br /><br />
