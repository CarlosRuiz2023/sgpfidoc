<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="solicitudes.aspx.vb" Inherits="Admin_procesos_solicitudes" Culture="Auto" UICulture="Auto" %>
            ...
            <div id="boxes">
                <div id="dialog" class="window">
                    ...
                    <div class="datos" id="bodymodaldatos">
                        ...
                        <input type="text" name="ubic" id="ubic" size="10" /><a href="#"
                            class="posicionar_solicitud">UBICAR</a>
                    </div>
                    <div class="botonessol">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_sol">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_sol">Cancelar</a></p>
                    </div>
                </div>
                <div id="dialogf" class="window">
                    ...
                    <div class="datos" id="bodyfact">
                        ...
                        <label for="name">Folio de FACTIBILIDAD: </label><input type="text" name="txtFolioDcto"
                            id="txtFolioDcto" size="20" /><br />
                        <label for="name">1.- Colonia regular:</label> <input type="checkbox" name="colreg"
                            id="txtcolreg" size="80" /><br />
                        <label for="name">2.- Servicio agua potable:</label> <input type="checkbox" name="servaguapot"
                            id="txtservaguapot" size="10" /><br />
                        <label for="name">3.- Servicio de Electricidad:</label> <input type="checkbox" name="servelect"
                            id="txtservelect" size="80" /><br />
                        <label for="name">4.- Servicio de drenaje y alcantarillado:</label> <input type="checkbox"
                            name="servdre" id="txtservdre" size="80" /><br />
                        <label for="name">5.- Pavimento colindante:</label> <input type="checkbox" name="pavcol"
                            id="txtpavcol" size="80" /><br />
                        <label for="name">6.- Afectación:</label> <input type="checkbox" name="afect" id="txtafect"
                            size="80" /><br />
                        <label for="name">7.- Sección menor a 13 mts:</label> <input type="checkbox" name="sec13"
                            id="txtsec13" size="80" /><br />
                        <label for="name">8.- Costos extras:</label> <input type="checkbox" name="costext"
                            id="txtcostext" size="80" /><br />
                        <label for="name">9.- Area de donación:</label> <input type="checkbox" name="areadon"
                            id="txtareadon" size="80" /><br />
                        <label for="name">10.-Consolidación:</label> <input type="checkbox" name="ubic"
                            id="txtconsolida" size="10" /><br /><br />
                        <label for="name">Observaciones técnicas:</label><br /> <textarea cols="82" rows="5"
                            name="observtec" id="txtobservtec" class="text"></textarea><br /><br />
                        <label for="name">Observaciones generales:</label><br /> <textarea cols="82" rows="5"
                            name="observgral" id="txtobservgral" class="text"></textarea><br /><br />
                        <label for="name">*ESTATUS FACTIBILIDAD:</label> <select name="EstFact"
                            id="lstEstFact"></select><br /><br />
                    ...
                    <div class="botonesf">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_fact">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_fact">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
            </div>
