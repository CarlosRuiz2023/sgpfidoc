<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consulta_inpc.aspx.vb"
    Inherits="Admin_procesos_consulta_inpc" %>
            ...
            <div id="boxes">
                <div id="dialogoinpc" class="window">
                    ...
                    <div class="datos" id="bodyinpc">
                        <label for="name" id="lblmes">*MES:</label><input type="number" id="txtmesinpc" min="1" max="12"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxlength); const hoy = new Date(); if (this.value > 12) this.value = 12; if (this.value < (hoy.getMonth())) this.value=hoy.getMonth();mes(this.value);"
                            maxlength="2" />&nbsp&nbsp&nbsp&nbsp&nbsp
                        <label for="name" id="lblyear">*AÑO:</label><input type="number" id="txtyearinpc" min="2022"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxlength);const hoy = new Date(); if (this.value > hoy.getFullYear() && hoy.getMonth()==0) { this.value = hoy.getFullYear()-1 } else { this.value = hoy.getFullYear() }; year(this.value);"
                            maxlength="4" /> &nbsp&nbsp&nbsp&nbsp&nbsp
                        <label for="name" id="lblyearmes">*AÑO/MES:</label><label for="name"
                            id="lblyearmes"></label><br /><br />
                        <label for="name" id="lblvalorinpc">*Valor del Indice Nacional del Consumidor:</label><input
                            type="number" min="1" max="500"
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); if (this.value > 200) this.value = 120;"
                            maxLength="7" name="inpc" id="txtinpc" size="10" /><br /><br />
                    </div>
                    <div class="botonesA" id="botonesinpc">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_inpc">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_inpc">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
            </div>
