<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_cv.aspx.vb"
    Inherits="Admin_procesos_consultar_cv" %>
        ...
        <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
            ...
            <script type="text/javascript" language="JavaScript">
                ...
                function ActualizarCV(idusu) {
                    //alert(img);
                    var url1 = "./cargar_cv.html?ResponseType=Edit&idusu=" + idusu;
                ...
                function InsertarMovs_CV(idusu) {
                    //alert(img);
                    var url1 = "./cargar_movs_cv.html?ResponseType=Edit&idusu=" + idusu;
                    newWindow = window.open(url1, "_blank", "top=150,left=200,menubar=no,toolbar=no,location=no, resizable=no,height=780,width=800,status=no,scrollbars=yes,minimizable=no,maxmizable=no,resizable=0,titlebar=no,modal=yes");
                    if (newWindow.focus()) {
                        newWindow.focus()
                    }
