<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_acta.aspx.vb" Inherits="Admin_procesos_consultar_acta" %>
...
<script type="text/javascript" language="JavaScript">
    ...
    function MostrarActas(idusu, filtro) {
        ...
        $("#grid").jqGrid(
         {
             datatype: function () {
                 $.ajax(
                   {
                       url: "../../WebServices/WebServiceActaComite.asmx/GetActas_Grid", //PageMethod
             ...
             colModel: [
                             {
                                 index: 'num_sesion', width: 50, align: 'Center', name: 'NumSesion'
                             },
                             {
                                 index: 'tipo_sesion', width: 100, align: 'Center', name: 'TipoSesion'
                             },
                             {
                                 index: 'fecha_sesion', width: 90, align: 'Center', name: 'FechaSesion'
                             },
                             {
                                 index: 'fecha_captura', width: 90, align: 'Center', name: 'FechaCaptura', hidden: true
                             },
                             {
                                 index: 'idusu_captura', width: 80, align: 'Center', name: 'IdUsuCap', hidden: true
                             },
                             {
                                 index: 'idacta', width: 80, align: 'Center', name: 'idacta', hidden: true
                             }],
             pager: "#pager", //Pager.                 
             ...
             width: "1500",
             height: "800",
             caption: "CATALOGO DE ACTAS DE COMITÉ",
             subGrid: true,
    ...
    function Buscar_Actas(idusu) {
        MostrarActas(idusu, ObtenerFiltro());
    }
    ...
    $(document).ready(function () {
        ...
        /*     $(".buscar_acta").click(function () {
                 Buscar_Roles(idusu);
             });
 
             $(".alta_acta").click(function () {
                 GestionRol(0, 0);
             });
             ...
             $(".posicion_boton_cancelar_acta").click(function (e) {
             ...
             $(".posicion_boton_accion_acta").click(function (e) {
                 EjecutarAccionRol();
             });
...
<label>Número de Sesión de comité:</label><input type="text" name="num_sesion_q" id="txtnum_sesion_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_acta"><== Buscar Acta de Comité==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_acta"><== Alta de Acta de Comité ==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogoacta" class="window"> 
       <div id="tituloacta"> 
         <p style="text-align:center">GESTION DE ACTAS DE COMITE</p>
         idActa: <label for="idacta" id="lblidacta"></label><br/>         
         Acción:<label for="accion" id="lblaccionacta"></label><br/>
       </div>
       <div class="datos" id="bodyrol">                  
          <label for="name" id="lblnum_sesion">*Número de Sesión:</label><input type="text" name="num_sesion" id="txtnum_sesion" size="80"/><br/><br/>
          <label for="name" id="lbltipo_sesion">*Tipo de Sesión:</label><input type="text" name="tipo_sesion" id="txttipo_sesion" size="80"/><br/><br/>          
          <label for="name" id="lblfec_sesion">*Fecha de Sesión:</label><input type="text" name="fecha_sesion" id="txtfec_sesion" size="80"/><br/><br/>
       </div>                  
       <div class="botonesA" id="botonesC">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_acta">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_acta">Cancelar</a></p>                
       </div>
    </div>
    <div id="asig_acuerdo" class="window">
          <table class="t_modulo">
              <tbody> 
                  <tr>
                      <td class="titulo_modulo" colspan="2">ASIGNACION DE ACUERDO</td>
                  </tr>   
                  <tr>
                      <td class="c" colspan="2"><label id="lblacta_asig"></label></td>
                  </tr>
                  <tr>
                      <td class="d">Número de Acuerdo: </td><td class="e"><input type="text" name="num_acuerdo" id="txtnum_acuerdo" size="80"/></td>
                  </tr>                                                     
                  <tr>
                      <td class="d">Descripción del Acuerdo: </td><td class="e"><textarea name="txtdescrip_acuerdo" id="txtdescrip_acuerdo" cols="100" rows="5"></textarea></td>
                  </tr>                                                     
                  <tr>
                      <td class="boton_dialog"><a href="#" class="accion_aceptar_asignar_acuerdo">ASIGNAR</a></td><td class="boton_dialog"><a href="#" class="accion_cancelar_asignar_acuerdo">CANCELAR</a></td>
                  </tr>                  
              </tbody>
          </table>
      </div>              
