<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_obra_contrato.aspx.vb" Inherits="Admin_procesos_consultar_obra_contrato" %>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><select class="select_captura" name="num_contrato"
                                        id="lstcontratos_contrato_obra"></select></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" class="boton_dialog"><a href="#"
                                        class="posicion_boton_accion_contrato_obra">ACEPTAR</a></td>
                                <td colspan="2" class="boton_dialog"><a href="#"
                                        class="posicion_boton_cancelar_contrato_obra">CANCELAR</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
