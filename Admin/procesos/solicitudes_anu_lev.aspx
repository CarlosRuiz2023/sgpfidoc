<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="solicitudes_anu_lev.aspx.vb" Inherits="Admin_procesos_solicitudes_anu_lev" %>
            ...
            <div id="boxes">
                <div id="dialogolev" class="window">
                    ...
                    <div class="datos" id="bodylev">
                        <label for="name">*Fecha solicitud Lev.:</label><input type="text" name="fecsolic"
                            id="txtfecsolic" size="10" maxlength="10" onkeyup="this.value=formateafecha(this.value);" />
                        dd/mm/aaaa<br /><br />
                        <label for="name">*Fecha entrega Lev.:</label><input type="text" name="fecentrega"
                            id="txtfecentrega" size="10" maxlength="10"
                            onkeyup="this.value=formateafecha(this.value);" /> dd/mm/aaaa<br /><br />
                        <label for="name">Dibujante:</label><select name="Usuario" id="lstUsuario"></select><br /><br />
                        <label for="name">Observaciones:</label><input type="text" name="observ" id="txtobserv"
                            size="200" /><br /><br />
                        <label for="name">Levantamiento:</label><input type="file" id="filelev" name="file" /><a
                            href="#" id="A2" class="verarchivo" />
                    </div>
                    <div class="botonesA" id="botonesC">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_lev">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_lev">Cancelar</a></p>
                    </div>
                </div>
                <div id="dialogopresup" class="window">
                    ...
                    <div class="datos" id="bodysolicpresup">
                        <label for="name">Fecha solicitud presupuesto:</label><input type="text" name="fecsolicpresup"
                            id="lblfecpresup" size="10" maxlength="10"
                            onkeyup="this.value=formateafecha(this.value);" /> dd/mm/aaaa<br /><br />
                        <label for="name">Solicitud Presupuesto (dcto):</label><input type="file" id="filesolicpresup"
                            name="file" /><a href="#" id="solicpresup" class="verarchivo" />
                    </div>
