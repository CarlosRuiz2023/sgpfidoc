<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_trans_pagos.aspx.vb" Inherits="Admin_procesos_consultar_trans_pagos" %>
    ...
    <div id="transf_pagos" class="window">
       <table class="t_modulo">
             <tbody> 
                  ...
                  <tr>
                      <td class="d">Referencia de Pago Origen:</td><td class="e"><label id="lblref_pago"></label></td><td class="titulo_modulo2" colspan="2">DATOS DE COOPERADOR DESTINO</td>
                  </tr>                                   
                  <tr>
                      <td class="d">Fecha de Pago:</td><td class="e"><label id="lblfec_pago"></label></td><td class="d">OBRA:</td><td class="e"><select class="list_captura" name="obras" id="lstobras" onchange="consulta_obra(this.value)"></select></td>
                  </tr>                     
                  <tr>
                      <td class="d">Monto del Pago:</td><td class="e"><label id="lblmonto_pago"></label><a href="#" class="pasar_total"> >>> </a></td><td class="d">Calle Obra Destino:</td><td class="e"><label id="lblobr_calle_destino"></label></td>
                  </tr>     
                  <tr>
                      <td class="d">Monto de Transf.:</td><td class="e"><input type="text" name="calle" id="txtMontoTransf" size="10" onkeypress="return filterFloat(event,this);"/></td><td class="d">Colonia Obra Destino:</td><td class="e"><label id="lblobr_colonia_destino"></label></td>
                  </tr>                                       
                  <tr>
                      <td class="titulo_modulo2" colspan="2">DATOS DE COOPERADOR ORIGEN</td><td class="d">Tramo de Obra Destino:</td><td class="e"><label id="lblobr_tramo_destino"></label></td>
                  </tr>                     
                  <tr>
                      <td class="d">Cve_Cooperador (fid:coop_s):</td><td class="e"><label id="lblfid"></label><label id="lblcoop3"></label></td><td class="d">Programa de Obra Destino:</td><td class="e"><label id="lblobr_prog_destino"></label></td>
                  </tr>                     
                  <tr>
                      <td class="d">Nombre del Cooperador:</td><td class="e"><label id="lblnom_coop"></label></td><td class="d">Estatus Obra Destino:</td><td class="e"><label id="lblobr_estatus_destino"></label></td>
                  </tr>                  
                  <tr>
                      <td class="d">Calle de Obra:</td><td class="e"><label id="lblcalle_obra"></label></td><td class="d">Cuenta Contable:</td><td class="e"><label id="lblobr_cta_contable"></label></td>
                  </tr>                  
                  <tr>
                      <td class="d">Colonia de la Obra:</td><td class="e"><label id="lblnom_col"></label></td><td class="d">Cooperadores de:</td><td class="e"><select class="list_captura" name="cooperadores" id="lstcoops" onchange="consulta_coop(this.value)"></select></td>
                  </tr>                  
                  <tr>
                      <td class="d">Tramo:</td><td class="e"><label id="lbltramo"></label></td><td class="d">Nombre de Cooperador:</td><td class="e"><label id="lblnomcoop_c"></label></td>
                  </tr>                  
                  <tr>
                      <td class="d">Estatus de la Obra:</td><td class="e"><label id="lblestatus_obra"></label></td><td class="d">Cta. Predial:</td><td class="e"><label id="lblctapredial_c"></label></td>
                  </tr>                  
                  <tr>
                      <td class="d">No. Oficial:</td><td class="e"><label id="lblnum_oficial"></label></td><td class="d">No. Oficial:</td><td class="e"><label id="lblnooficial_c"></label></td>
                  </tr> 
                   <tr>
                      <td class="boton_dialog" colspan="2"><a href="#" class="accion_cancelar_trans_pago">CANCELAR</a></td><td class="boton_dialog" colspan="2"><a href="#" class="accion_aceptar_trans_pago">TRANSFERIR</a></td>
                  </tr>                       
             </tbody>
       </table>       
    </div>        
