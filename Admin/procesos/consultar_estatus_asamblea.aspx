<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_estatus_asamblea.aspx.vb" Inherits="Admin_procesos_consultar_estatus_asamblea" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>Nombre del Estatus de Asamblea:</label><input type="text" name="nomEstatusAsamblea_q"
            id="txtnomEstatusAsamblea_q" style="width:250px"
            maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_estatus_asamblea">
            <== Buscar Estatus Asamblea==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_estatus_asamblea">
            <== Alta Estatus Asamblea==>
        </a><br /><br />
        ...
        <div id="boxes">
            <div id="dialogo_EstatusAsamblea" class="window">
                ...
                <div class="datos" id="bodyEstatusAsamblea">
                    <label for="name" id="lbletiqueta_estatus_asamblea">*Nombre de Estatus de Asamblea:</label><input
                        type="text" name="EtiquetaEstatusAsamblea" id="txtetiqueta_estatus_asamblea"
                        size="80" /><br /><br />
                </div>
                <div class="botonesA" id="botonesC">
                    <p style="text-align:right"><a href="#"
                            class="posicion_boton_estatus_asamblea_accion">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                            class="posicion_boton_cancelar_estatus_asamblea">Cancelar</a></p>
                </div>
            </div>
            <div id="mask"></div>
        </div>
