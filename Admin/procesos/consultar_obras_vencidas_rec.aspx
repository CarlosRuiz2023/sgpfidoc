<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_obras_vencidas_rec.aspx.vb" Inherits="Admin_procesos_consultar_obras_vencidas_rec" %>
                ...
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="e" colspan="3"><select class="select_captura" name="comite_tecnico"
                                    id="lstcomite_tecnico"></select></td>
                        </tr>
                        <tr>
                            <td class="f">Acuerdo:</td>
                            <td class="e" colspan="3"><select class="select_captura" name="acuerdo_comite"
                                    id="lstacuerdo_comite"></select></td>
                        </tr>
                        <tr>
                            <td class="boton_dialog" colspan="4"><a href="#" class="ver_doc_comite"><label
                                        id="lblacta_comite" /></a></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_accion_comite_obra">ACEPTAR</a></td>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_comite_obra">CANCELAR</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="e" colspan="3"><input type="text" class="numbersOnly" name="monto_con_iva"
                                    id="txtcosto_nuevo_obra" size="10" maxlength="15" /></td>
                        </tr>
                        <tr>
                            <td class="f">Presupuesto Nuevo:</td>
                            <td class="e" colspan="3"><input type="file" id="file_presup_nuevo"
                                    name="file" />&nbsp&nbsp<a href="#" id="archivo_presup_nuevo"
                                    class="verarchivo"></a></td>
                        </tr>
                        <tr class="renglon_sistema">
                            <td>oid:</td>
                        ...
                        <tr>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_accion_costo_nuevo_obra">ACEPTAR</a></td>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_costo_nuevo_obra">CANCELAR</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
