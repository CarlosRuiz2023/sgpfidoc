<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_accion.aspx.vb" Inherits="Admin_procesos_consultar_accion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Nombre del Accion:</label><input type="text" name="nomAccion_q" id="txtnomAccion_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_accion"><== Buscar Accion ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_accion"><== Alta Accion ==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogoAccion" class="window"> 
       ...
       <div class="datos" id="bodyAccion">                  
          <label for="name" id="lblAccionnombre">*Nombre de Accion:</label><input type="text" name="EtiquetaAccion" id="txtetiqueta_accion" size="80"/><br/><br/>          
       </div>                  
       <div class="botonesA" id="botonesC">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_accion">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_accion_accion">Cancelar</a></p>                
       </div>
    </div>     
    <div id="mask"></div>
 </div>
