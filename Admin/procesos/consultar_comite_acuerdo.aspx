<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_comite_acuerdo.aspx.vb" Inherits="Admin_procesos_consultar_comite_acuerdo" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>No. Sesión Comité:</label><input type="text" name="num_sesion" id="txtnum_sesion_q" style="width:250px"
            maxlength="6" onkeyup="this.value=formatea_num_sesion(this.value);" /><br /><br />
        <input type="checkbox" name="acuerdos_terminados" id="chkacuerdos_terminados" class="checkboxAcuerdosTerminados"
            checked /><label>Acuerdos Terminados</label><br /><br />
        <input type="checkbox" name="acuerdos_no_terminados" id="chkacuerdos_no_terminados"
            class="checkboxAcuerdosNoTerminados" checked /><label>Acuerdos No Terminados</label><br /><br />
        <label>Descripcion Acuerdo:</label><input type="text" name="descrip_acuerdo" id="txtdescrip_acuerdo_q" size="30"
            maxlength="30" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_comite">
            <== Buscar COMITE TECNICO==>
        </a><br /><br />
                ...
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="e"><select name="tipo_sesion" id="lsttipo_sesion"
                                    onchange="actualiza_tipo_sesion(this.options[this.selectedIndex].text);"></select>
                            </td>
                            <td class="f">Fecha Comité Técnico:</td>
                            <td class="dato_captura"><input type="text" name="fec_comite" id="txtfec_comite" size="10"
                                    maxlength="10" onkeyup="this.value=formateafecha(this.value);" /></td>
                        </tr>
                        <tr>
                            <td class="f">Formato de Comité:</td>
                            <td class="e"><select name="formato_comite" id="lstformato_comite"
                                    onchange="actualiza_formato_comite(this.options[this.selectedIndex].text);"></select>
                            </td>
                            <td class="f">No. Sesión:</td>
                            <td class="e"><input type="text" name="num_sesion" id="txtnum_sesion" size="3" maxlength="3"
                                    onkeyup="this.value=formatea_num_sesion(this.value);" /> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="e" colspan="3"><input type="file" id="file_acta" name="file" />&nbsp&nbsp<a
                                    href="#" id="archivo" class="verarchivo"></a></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_accion_comite">ACEPTAR</a></td>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_comite">CANCELAR</a></td>
                ...
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="e"><input type="text" name="num_acuerdo" id="txtnum_acuerdo" size="3"
                                    maxlength="3" onkeyup="CreaFolioAcuerdo(this.value);" /></td>
                        </tr>
                        <tr>
                            <td class="f">Número Acuerdo Romano:</td>
                            <td class="e"><label id="lblnum_acuerdo_romano" /></td>
                            <td class="e" colspan="2"><input type="checkbox" id="check_acuerdo" /><label for="check1"
                                    id="lblacuerdo_terminado"></label></td>
                        </tr>
                        <tr>
                            <td class="f">Encabezado de Acuerdo:</td>
                            <td class="e" colspan="3"><textarea name="encabezado_acuerdo" id="txtdescrip_acuerdo"
                                    cols="80" rows="20"></textarea></td>
                        </tr>
                        <tr class="renglon_sistema">
                            <td>idAcuerdo:</td>
                        ...
                        <tr>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_accion_acuerdo">ACEPTAR</a></td>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_acuerdo">CANCELAR</a></td>
