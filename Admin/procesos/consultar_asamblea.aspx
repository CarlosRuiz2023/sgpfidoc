<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_asamblea.aspx.vb" Inherits="Admin_procesos_consultar_asamblea" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>Calle Asamblea:</label><input type="text" name="calle_asamblea" id="txtcalle_asamblea_q"
            style="width:250px" maxlength="120" /><br /><br />
        <label>Colonia Aamblea:</label><input type="text" name="colonia_asamblea" id="txtcolonia_asamblea_q"
            style="width:250px" maxlength="120" /><br /><br />
        <label>Promotor:</label><input type="text" name="promotor_asamblea" id="txtpromotor_asamblea_q"
            style="width:250px" maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#"
            class="buscar_asamblea">
            <== Buscar Asamblea==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_asamblea">
            <== Alta Asamblea==>
        </a><br /><br />
            ...
            <div id="dialogo_asamblea" class="window">
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            <td class="f">CALLE:</td>
                            <td class="ee" colspan="3"><label id="lblcalle"></label></td>
                        </tr>
                        <tr>
                            <td class="f">COLONIA:</td>
                            <td class="ee" colspan="3"><label id="lblcolonia" /></td>
                        </tr>
                        <tr>
                            <td class="f">TRAMO:</td>
                            <td class="ee" colspan="3"><label id="lbltramo" /></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="e"><input type="text" class="numbersOnly" name="num_asistentes_m"
                                    id="txtnum_asistentes" size="4" maxlength="4" /></td>
                            <td class="f">Asistentes Mujeres:</td>
                            <td class="e"><input type="text" class="numbersOnly" name="num_asistentes_m"
                                    id="txtnum_asistentes_m" size="4" maxlength="4" /></td>
                        </tr>
                        <tr>
                            <td class="f">Fecha Asamblea:</td>
                            <td class="e"><input type="text" name="fec_asambles" id="txtfec_asamblea" size="10"
                                    maxlength="10" onkeyup="this.value=formateafecha(this.value);" /></td>
                            <td class="f">Promotor Asamblea:</td>
                            <td class="e"><select class="select_captura" name="promotores" id="lstpromotor"></select>
                            </td>
                        </tr>
                        <tr>
                            <td class="f">Documento de Asamblea:</td>
                            <td class="e"><input type="file" id="file_asam" name="file" />&nbsp&nbsp<a href="#"
                                    id="archivo" class="verarchivo"></a></td>
                            <td class="f">Tipo Asamblea:</td>
                            <td class="e"><select class="select_captura" name="tipo_asamblea_"
                                    id="lsttipo_asamblea"></select></td>
                        </tr>
                        <tr>
                            <td class="f">Observaciones/Notas Importantes:</td>
                            <td class="e" colspan="3"><textarea name="descrip_lugar" id="txtdescrip_lugar" cols="112"
                                    rows="4"></textarea></td>
                        </tr>
                        <tr class="renglon_sistema">
                            <td>idAsamblea:</td>
                        ...
                        <tr>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_accion_asamblea">ACEPTAR</a></td>
                            <td colspan="2" class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_asamblea">CANCELAR</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            <div id="dialogo_asamblea_base" class="window">
                <table class="t_modulo">
                    <tbody>
                        ...
                        <tr>
                            <td class="f">Obra:</td>
                            <td class="e"><select class="select_captura" name="obras_s" id="lstobras_sgp_base"></select>
                            </td>
                        </tr>
                        <tr>
                            <td class="f">Calle:</td>
                        ...
                        <tr>
                            ...
                            <td class="e"><select class="select_captura" name="tipo_asamblea"
                                    id="lsttipo_asamblea_base"></select></td>
                        </tr>
                        <tr class="renglon_sistema">
                            <td>oid:</td>
                        ...
                        <tr>
                            <td class="boton_dialog"><a href="#" class="posicion_boton_accion_base_asamblea">ACEPTAR</a>
                            </td>
                            <td class="boton_dialog"><a href="#"
                                    class="posicion_boton_cancelar_base_asamblea">CANCELAR</a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
