<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="consultar_tarea.aspx.vb" Inherits="Admin_procesos_consultar_tarea" Culture="Auto" UICulture="Auto"%>
...
<label>Nombre de la Tarea:</label><input type="text" name="nomtarea_q" id="txtnomtarea_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_tarea"><== Buscar Tarea ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tarea"><== Alta Tarea ==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogotarea" class="window"> 
       ...
       <div class="datos" id="bodytarea">                  
          <label for="name" id="lbltareanombre">*Nombre de tarea:</label><input type="text" name="tareanombre" id="txttareanombre" size="80"/><br/><br/>
          <label for="name" id="lbltareadescrip">*Descripción del tarea::</label><input type="text" name="descriptarea" id="txttareadescrip" size="80"/><br/><br/>          
          <label for="name" id="lblprocedalmac">Nombre de Precedimiento Almacenado:</label><input type="text" name="procedalmac" id="txtsp" size="80"/><br/><br/>          
          <label for="name" id="lbllimautor">*Limite de Autorizacion:</label><input type="text" name="limtarea" id="txtlimtarea" size="80"/><br/><br/>          


       </div>                  
       <div class="botonesA" id="botonesC">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_tarea">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_tarea">Cancelar</a></p>                
       </div>
    </div>     
    <div id="mask"></div>
 </div>
