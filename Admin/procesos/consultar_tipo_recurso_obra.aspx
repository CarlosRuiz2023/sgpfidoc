<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_tipo_recurso_obra.aspx.vb" Inherits="Admin_procesos_consultar_tipo_recurso_obra" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>Tipo de Recurso: </label><input type="text" name="tipo_recurso" id="txttipo_recurso_q"
            style="width:250px" maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#"
            class="buscar_tipo_recurso">
            <== Buscar Tipo de Recurso==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tipo_recurso">
            <== Alta Tipo Recurso==>
        </a><br /><br />
        ...
        <div id="boxes">
            <div id="dialogo_trecurso" class="window">
                ...
                <div class="datos" id="bodyAccion">
                    <label for="name" id="lbldescripcion_trecurso">*Etiqueta del Tipo de Recurso:</label><input
                        type="text" name="Etiqueta del Tipo de Recurso:" id="txtdescripcion_tipo_recurso"
                        size="60" /><br /><br />
                    <label for="name" id="Label1">*Observación del Tipo de Recurso:</label><input type="text"
                        name="Observación del Tipo de Recurso:" id="txtobserv_tipo_recurso" size="120" /><br /><br />
                </div>
                <div class="botonesA" id="botonesC">
                    <p style="text-align:right"><a href="#"
                            class="posicion_boton_accion_tipo_recurso">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                            class="posicion_boton_cancelar_tipo_recurso">Cancelar</a></p>
                </div>
            </div>
            <div id="mask"></div>
        </div>
