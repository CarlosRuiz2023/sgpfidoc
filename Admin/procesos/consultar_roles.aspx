<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="consultar_roles.aspx.vb" Inherits="Admin_procesos_consultar_roles" Culture="Auto" UICulture="Auto" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <label>Nombre del Rol:</label><input type="text" name="nomrol_q" id="txtnomrol_q" style="width:250px"
                maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_rol">
                <== Buscar Rol==>
            </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_rol">
                <== Alta Rol==>
            </a><br /><br />
            ...
            <div id="boxes">
                <div id="dialogorol" class="window">
                    ...
                    <div class="datos" id="bodyrol">
                        <label for="name" id="lblrolnombre">*Nombre de Rol:</label><input type="text" name="rolnombre"
                            id="txtrolnombre" size="80" /><br /><br />
                        <label for="name" id="lblroldescrip">*Descripción del Rol::</label><input type="text"
                            name="descriprol" id="txtroldescrip" size="80" /><br /><br />
                    </div>
                    <div class="botonesA" id="botonesC">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_rol">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_rol">Cancelar</a></p>
                    </div>
                </div>
                <div id="asig_tarea" class="window">
                    <table class="t_modulo">
                        <tbody>
                            ...
                            <tr>
                                <td class="d">ACCION: </td>
                                <td class="e"><select name="accion" id="lstaccion_asig"></select></td>
                            </tr>
                            <tr>
                                <td class="d">TAREA: </td>
                                <td class="e"><select name="tarea" id="lsttarea_asig"></select></td>
                            </tr>
                            <tr>
                                <td class="boton_dialog"><a href="#" class="accion_aceptar_asignar_tarea">ASIGNAR</a>
                                </td>
                                <td class="boton_dialog"><a href="#" class="accion_cancelar_asignar_tarea">CANCELAR</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
