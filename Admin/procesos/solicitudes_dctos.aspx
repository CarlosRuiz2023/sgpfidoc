...
<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="solicitudes_dctos.aspx.vb" Inherits="Admin_procesos_solicitudes_dctos" %>
  ...
  <div id="boxes">
    <div id="dialogoDcto"  class="window">         
      ...
      <div class="datos" id="bodyfact">
        <label for="name">Tipo de DOCUMENTO:</label> <select name="tipodoc" id="lsttipodoc"></select><br/><br/> 
        <label for="name">Folio de DOCUMENTO: </label><input type="text" name="txtFolioDcto" id="txtFolioDcto" size="20"/><br/><br/>
        <label for="name">Fecha envío:</label>  <input type="text" name="fecenvio" id="txtfecenvio" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/> dd/mm/aaaa<br/><br/>
        ...
        <label for="name">Nombre de usuario quien recibe:</label> <select name="Usuario" id="lstUsuario"></select><br/><br/>         
        <label for="name">Factibilidad:</label><input type="file" id="file1" name="file"/>      <a href="#" id="archivo" class="verarchivo"/>       
      </div>            
      <div class="botonesf">
        <p style="text-align:right"><a href="#" class ="posicion_boton_accion_dcto">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_dcto">Cancelar</a></p>                
      </div>
    </div>        
    <div id="mask"></div>
</div>
