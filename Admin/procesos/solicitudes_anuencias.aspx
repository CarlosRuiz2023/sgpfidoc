<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="solicitudes_anuencias.aspx.vb" Inherits="Admin_procesos_solicitudes_anuencias" %>
            ...
            <div id="boxes">
                <div id="dialogoAnu" class="window">
                    ...
                    <div class="datos" id="bodyAnu">
                        <label for="name">Folio de anuencia:</label><input type="text" name="txtFolioAnu"
                            id="txtFolioAnu" size="20" /><br /><br />
                        <label for="name">Fecha entrega:</label><input type="text" name="fecenvio" id="txtfecentrega"
                        ...
                        <label for="name">Fecha recepción:</label><input type="text" name="fecrecep" id="txtfecrecep"
                            size="10" maxlength="10" onkeyup="this.value=formateafecha(this.value);" />
                        dd/mm/aaaa<br /><br />
                        <label for="name">Promotor de calle:</label><input type="text" name="txtNomProm" id="txtNomProm"
                            size="40" /><br /><br />
                        <label for="name">Domicilio promotor de calle:</label> <input type="text" name="txtDomProm"
                            id="txtDomProm" size="60" /><br /><br />
                        <label for="name">Teléfono de promotor de calle:</label> <input type="text" name="txtTelProm"
                            id="txtTelProm" size="10" /><br /><br />
                        <label for="name">Promotor FIDOC:</label> <select name="Usuario"
                            id="lstUsuario"></select><br /><br />
                        <label for="name">Dcto. de Anuencia:</label><input type="file" id="file1" name="file" /> <a
                            href="#" id="archivo" class="verarchivo" />
                    </div>
                    <div class="botonesA" id="botonesA">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_anu">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_anu">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
            </div>
