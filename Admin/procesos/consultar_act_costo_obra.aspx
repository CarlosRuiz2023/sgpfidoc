<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_act_costo_obra.aspx.vb" Inherits="Admin_procesos_consultar_act_costo_obra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Calle Act_costo_obra:</label><input type="text" name="calle_act_costo_obra" id="txtcalle_act_costo_obra_q" style="width:250px" maxlength ="120"/><br/><br/>            
    <label>Colonia:</label><input type="text" name="colonia_act_costo_obra" id="txtcolonia_act_costo_obra_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_actualizacion"><== Buscar Actualización de Costo Obra ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_actualizacion"><== Alta Actualización de Costo de Obra ==></a><br/><br/>
    ...
    <div id="dialogo_act_costo_obra" class="window">        
       <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  <td class="f">Folio:</td>   
                  <td class="e"><input type="text" name="folio_act_costo_obra" id="txtfolio_act_costo_obra" size="10" maxlength="10"/></td>               
                  <td class="f">Fecha:</td>   
                  <td><input type="text" name="fec_act_costo_obra" id="txtFecCostoObra" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/></td>               
                  <td class="f">Asamblea:</td>   
                  <td class="e"><select name="obras_s" id="Select1" onchange="LlenaLabelObra(this.options[this.selectedIndex].text);"></select></td>               
              </tr>                                                                                                                                                                                                                                                                                                                                                                       
              <tr>                  
                  <td class="f">Calle:</td>
              ...
              <tr>
                  ...
                  <td class="e"><select name="obras_s" id="lstcomite" onchange="LlenaLabelObra(this.options[this.selectedIndex].text);"></select></td>     
              ...
              <tr>
                  ...
                  <td class="e"><input type="text" name="fec_programa" id="txtfec_programa" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);" /></td>                                           
              ...
              <tr>
                  <td  colspan="3" class="boton_dialog"><a href="#" class ="posicion_boton_accion_act_costo_obra">ACEPTAR</a></td>                  
                  <td  colspan="3" class="boton_dialog"><a href="#" class ="posicion_boton_cancelar_act_costo_obra">CANCELAR</a></td>                  
              </tr>
