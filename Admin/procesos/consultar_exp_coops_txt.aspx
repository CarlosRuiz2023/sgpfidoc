<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_exp_coops_txt.aspx.vb" Inherits="Admin_procesos_consultar_exp_coops_txt" %>
    ...
    <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td  class="e"><input class="dato_captura" type="text" name="nomobra" id="txtnomobra" size="80" maxlength="120"/></td>
              </tr>   
              <tr>
                  <td  class="f">Obra_SIFIDOC:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="obra_s" id="txtobra_s" size="10" maxlength="10"/></td>
              </tr>
              <tr>
                  <td class="f">Obra_SGPFIDOC:</td>
                  <td class="e"><input class="dato_captura" type="text" name="obra_sgp" id="txtobra_sgp" size="10" maxlength="10"/></td>                                                                        
              </tr>                                                     
              <tr>                               
                  <td colspan="2" class="boton_dialog"><a>Buscar Obras >>></a></td>
              </tr>                                                                       
              <tr>
                  <td colspan="2"><table id="grid"></table><div id="pager"></div></td>     
              </tr>
          </tbody>
    </table>        
</div>
   ...
   <div id="dialogo_rep3" class="window"> 
     <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  <td  class="f">Fecha de Actualización del Reporte:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="fecrepact" id="txtfec_act_rep3" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>                
              <tr>                               
   ...
   <div id="dialogo_rep4" class="window"> 
     <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  <td  class="f">Fecha de Actualización del Reporte:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="fecrepact" id="txtfect_act_rep4" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>                
              <tr>                               
