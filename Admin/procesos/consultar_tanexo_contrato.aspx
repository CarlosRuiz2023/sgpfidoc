<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="consultar_tanexo_contrato.aspx.vb" Inherits="Admin_procesos_consultar_tanexo_contrato" Culture="Auto"
    UICulture="Auto" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>Nombre del Tipo de Anexo de Contrato:</label><input type="text" name="nom_tipo_anexo_tarea_q"
            id="txttipo_anexo_tarea_q" style="width:250px"
            maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#"
            class="buscar_tipo_anexo_contrato">
            <== Buscar Tipo Anexo del Contrato==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tipo_anexo_contrato">
            <== Alta Tipo de anexo de Contrato==>
        </a><br /><br />
        ...
        <div id="boxes">
            <div id="dialogo_tipo_anexo_contrato" class="window">
                ...
                <div class="datos" id="bodytarea">
                    <label for="name" id="lbltareanombre">*Etiqueta del Tipo de Anexo del Contrato:</label><input
                        type="text" name="tipo_anexo_contrato" id="txtetiqueta_tipo_anexo_contrato"
                        size="80" /><br /><br />
                    <label for="name" id="lbltareadescrip">*Descripción del Tipo de Anexo del Contrato:</label><input
                        type="text" name="descrip_tipo_anexo_contrato" id="txtobserv_tipo_anexo_contrato"
                        size="80" /><br /><br />
                </div>
                <div class="botonesA" id="botonesC">
                    <p style="text-align:right"><a href="#"
                            class="posicion_boton_accion_tanexo_cont">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                            class="posicion_boton_cancelar_tanexo_cont">Cancelar</a></p>
                </div>
            </div>
            <div id="mask"></div>
        </div>
