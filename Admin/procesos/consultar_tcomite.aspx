<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_tcomite.aspx.vb" Inherits="Admin_procesos_consultar_tcomite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Tipo de Comité Técnico: </label><input type="text" name="tipo_comite" id="txttipo_comite_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_tipo_comite"><== Buscar Tipo de Comité ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tipo_comite"><== Alta Tipo Comité==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogo_tcomite" class="window"> 
       ...
       <div class="datos" id="bodyAccion">                  
          <label for="name" id="lbletiqueta_comite">*Nombre de Tipo de Comité:</label><input type="text" name="Etiqueta Tipo de Comité" id="txtetiqueta_tipo_comite" size="60"/><br/><br/>          
          <label for="name" id="lbldescripcion_comite">*Descripción del Tipo de Comité:</label><input type="text" name="Descripcion del Tipo de Comité:" id="txtdescripcion_tipo_comite" size="120"/><br/><br/>          
       </div>                  
       <div class="botonesA" id="botonesC">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_formato_comite">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_formato_comite">Cancelar</a></p>                
       </div>
    </div>     
    <div id="mask"></div>
 </div>
