<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_pobra.aspx.vb"
    Inherits="Admin_procesos_consultar_pobra" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <label>Calle:</label><input type="text" name="calle" id="txtnomcalle" style="width:250px"
                maxlength="120" /><br /><br />
            <label>Colonia:</label><input type="text" name="calle" id="txtcolonia" style="width:250px"
                maxlength="120" /><br /><br />
            <label>Tramo:</label><input type="text" name="calle" id="txttramo" style="width:250px"
                maxlength="120" /><br /><br />
            <label>OID_Obra:</label><input type="text" name="obra" id="txtoid" style="width:250px"
                maxlength="10" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_pobra">
                <== Buscar Polígono de Obra==>
            </a><br /><br />
