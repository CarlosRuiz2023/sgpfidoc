<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="adeudos_sin_det.aspx.vb" Inherits="Admin_procesos_adeudos_sin_det" %>
...
<label>No. Obra:</label><input type="text" name="obra" id="txtnumobra" style="width:250px" maxlength="10"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_obra"><== Buscar obra ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_obra"><== Alta obra ==></a><br/><br/>
