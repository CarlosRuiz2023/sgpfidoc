<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_reportes_obras.aspx.vb" Inherits="Admin_procesos_consultar_reportes_obras" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">  
    <table class="t_modulo">
          <tbody> 
              ...
              <tr>                  
                  <td  class="f"><a href="#" class ="t_accion"><label id="lblrep1">REPORTE DE OBRA POR ESTATUS Y FECHA DE PAGOS >>></label></a></td>
              </tr>   
              <tr>
                  <td  class="f"><a href="#" class ="t_accion"><label id="lblrep2">REPORTE DE COOPERADORES POR OBRA >>></label></a></td>                  
              </tr>
              <tr>
                  <td  class="f"><a href="#" class ="t_accion"><label id="lblrep3">REPORTE DE PAGOS POR OBRA (SOLO <=31 DIAS)>>></label></a></td>                  
              </tr>                  
          </tbody>
    </table>        
     ...
     <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td  class="e"><input class="dato_captura" type="text" name="fecrepact" id="txtfec_act_rep2" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>   
              <tr>
                  <td  class="f">Estatus de Obra:</td>
                  <td  class="e"><select class="dato_captura" name="estatus_obra" id="lstestatus_obra"></select></td>
              </tr>              
              <tr>                               
   ...
   <div id="dialogo_rep2" class="window"> 
     <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  <td  class="f">Obra:</td>
                  <td  class="e"><select class="dato_captura" name="obr_clv_int" id="lstobras_rep2"></select></td>
              </tr>   
              <tr>
                  <td  class="f">Considerar movimientos hasta el día:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="fecrepact" id="txtfec_lim_coop" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>              
              <tr>                               
    ...
    <div id="dialogo_rep3" class="window"> 
     <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  <td  class="f">Obra:</td>
                  <td  class="e"><select class="dato_captura" name="obr_clv_int" id="lstobras_rep3"></select></td>
              </tr>   
              <tr>
                  <td  class="f">Fecha Inicial:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="fecini" id="txtfecinipag" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>              
              <tr>
                  <td  class="f">Fecha Final:</td>
                  <td  class="e"><input class="dato_captura" type="text" name="fecfin" id="txtfecfinpag" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>
              </tr>              
              <tr>                               
