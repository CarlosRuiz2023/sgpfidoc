<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="consultar_usuarios.aspx.vb" Inherits="Admin_procesos_consulta_usuarios" Culture="Auto" UICulture="Auto" %>
            ...
            <div id="boxes">
                <div id="dialogousuario" class="window">
                    ...
                    <div class="datos" id="bodyusuario">
                        <label for="name" id="lblusunombre">*Nombre de usuario:</label><input type="text"
                            name="usunombre" id="txtusunombre" size="80" /><br /><br />
                        <label for="name" id="lblarea">*Área de trabajo:</label><select name="areatrabajo"
                            id="lstareatrabajo"></select><br /><br />
                        <label for="name" id="lblusucorreo">*Correo electrónico:</label><input type="text" name="email"
                            id="txtemail" size="100" /><br /><br />
                        <label for="name" id="lblusucuenta">*Cuenta:</label><input type="text" name="cuenta"
                            id="txtcuenta" size="50" /><br /><br />
                        <label for="name" id="lblusupass">*Contraseña:</label><input type="text" name="contraseña"
                            id="txtcontra" size="50" /><br /><br />
                        <label for="name" id="lblusurol">*Rol de Usuario:</label><select name="rol"
                            id="lstrol"></select><br /><br />
                        <label for="name" id="lblnumempleado">*Numero empleado: </label><input type="text"
                            name="numempleado" id="txtnumempleado" size="10" maxlength="10" /><br /><br />
                        <label for="name" id="lblusurfc">Rfc:</label><input type="text" name="rfc" id="txtrfc"
                            size="15" /><br /><br />
                        <label for="name" id="lblusucurp">CURP:</label><input type="text" name="curp" id="txtcurp"
                            size="30" /><br /><br />
                    </div>
                    <div class="botonesA" id="botonesC">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_usuario">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_usuario">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
            </div>
