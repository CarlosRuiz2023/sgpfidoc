<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_fcomite.aspx.vb" Inherits="Admin_procesos_fcomite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Formato de Comité Técnico: </label><input type="text" name="Formato_comite" id="txtformato_comite_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_formato_comite"><== Buscar Formato de Comité ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_formato_comite"><== Alta Formato Comité==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogo_fcomite" class="window"> 
       ...
       <div class="datos" id="bodyAccion">                  
          <label for="name" id="lbletiqueta_comite">*Nombre de Formato de Comité:</label><input type="text" name="Etiqueta Formato de Comité" id="txtetiqueta_formato_comite" size="60"/><br/><br/>          
          <label for="name" id="lbldescripcion_comite">*Descripción del Formato de Comité:</label><input type="text" name="Descripcion del Formato de Comité:" id="txtdescripcion_formato_comite" size="120"/><br/><br/>          
       </div>                  
