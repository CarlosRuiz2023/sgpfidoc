<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_contrato.aspx.vb" Inherits="Admin_procesos_consultar_contrato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Contrato:</label><input type="text" name="contrato" id="txtnum_contrato_q" style="width:250px" maxlength ="120"/><br/><br/>
    <label>RFC Contratista:</label><input type="text" name="contrato" id="txtrfc_contratista_q" style="width:250px" maxlength ="13"/><br/><br/>
    <label>Nombre Contratista:</label><input type="text" name="contrato" id="txtnom_contratista_q" style="width:300px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_contrato"><== Buscar CONTRATO ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_contrato"><== Alta CONTRATO ==></a><br/><br/>        
       ...
       <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td class="e"><input class="dato_captura" type="text" name="num_contrato" id="txtnum_contrato"  size="26" maxlength="26"  onkeyup = "this.value=valida_alfanumericos(this.value);"/></td> 
                  <td class="e"><label id="lblnum_contrato_limpio"/></td>
              </tr>                                                                                                                                                                                                                                                                                                                                                                       
              <tr>                  
                  <td class="f">Monto con IVA:</td>
                  <td class="e"><input type="text" class="numbersOnly" name="monto_con_iva" id="txtmonto_con_iva" size="12" maxlength="15" onkeyup="asigna_valores_calculados(this.value);"/></td>
                  <td class="f">Monto sin IVA:</td>
                  <td class="e"><input type="text" class="numbersOnly" name="monto_sin_iva" id="txtmonto_sin_iva" size="12" maxlength="15"/></td>
              </tr>             
              <tr>
                  <td class="f">IVA:</td>
                  <td class="e"><input type="text" class="numbersOnly" name="iva" id="txtiva" size="12" maxlength="15"/></td>
                  <td class="f">Anticipo:</td>
                  <td class="e"><input type="text" class="numbersOnly" name="anticipo" id="txtanticipo" size="12" maxlength="15"/></td>                  
              </tr>
              <tr>
                  <td class="f">Fecha Adjudicación:</td>
                  <td class="e"><input type="text" name="fec_contrato" id="txtfec_contrato" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>                                           
                  <td class="f">Fecha Inicio Obra:</td>
                  <td class="e"><input type="text" name="fec_ini_contrato" id="txtfec_ini_contrato" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/></td>                                           
              </tr>
              <tr>
                  <td class="f">Fecha Prorroga:</td>
                  <td class="e"><input type="text" name="fec_prorroga" id="txtfec_prorroga" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/></td>                                           
                  <td class="f">Fecha Fin Obra:</td>
                  <td class="e"><input type="text" name="fec_fin_contrato" id="txtfec_fin_contrato" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/></td>                                           
              </tr>
              <tr>
                  <td class="f">Documento Contrato:</td>
                  <td class="e" colspan="3"><input type="file" id="file1" name="file"/> <a href="#" id="archivo" class="verarchivo_contrato"></a></td>                  
              </tr>
              <tr>                  
                  <td class="f">Contratista:</td>
                  <td class="e" colspan="3"><select class="select_captura" name="contratista" id="lstcontratista"></select></td>
              </tr>              
              <tr>
                  <td class="f">Tipo Asignación:</td>
                  <td class="e" colspan="3"><select class="select_captura" name="tasignacion" id="lsttasignacion"></select></td>
              </tr>                    
              <tr>
                  <td class="f">Observaciones:</td>
                  <td class="e" colspan="3"><textarea name="observ_contrato" id="txtobserv_contrato" cols="100" rows="5"></textarea></td>                 
              </tr>       
              ...
              <tr>                                              
                  <td  colspan="2" class="boton_dialog"><a href="#" class ="posicion_boton_accion_contrato">ACEPTAR</a></td>                  
                  <td  colspan="2" class="boton_dialog"><a href="#" class ="posicion_boton_cancelar_contrato">CANCELAR</a></td>                  
              </tr>
          </tbody>
       </table>
    </div>     
       ...
       <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td class="e"><select class="select_captura" name="tipo_anexo_contrato" id="lsttipo_anexo_contrato"></select></td>
              </tr>             
               <tr class="renglon_sistema">
                  <td>idContrato:</td>
              ...
              <tr>                                              
                  <td class="boton_dialog"><a href="#" class ="posicion_boton_accion_tipo_anexo_contrato">ACEPTAR</a></td>                  
                  <td class="boton_dialog"><a href="#" class ="posicion_boton_cancelar_tipo_anexo_contrato">CANCELAR</a></td>                  
              </tr>
          </tbody>
       </table>
    </div>     
       ...
       <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td class="e"><input type="text" name="fec_contrato" id="txtfecha_param1" size="10" maxlength="10"  onkeyup = "this.value=formateafecha(this.value);"/></td>     
              </tr>                  
              <tr>
                  <td class="f"><label id="lblvalor_param3_integer"/></td>
                  <td class="e"><input class="numbersOnly" type="text" name="valor_param_3_integer" id="txtvalor_param3_integer" size="10" maxlength="10"/></td>     
              </tr>                  
              <tr>
                  <td class="f"><label id="lblvalor_param4_double"/></td>
                  <td class="e"><input class="numbersOnly" type="text" name="valor_param_4_double" id="txtvalor_param4_double" size="10" maxlength="10"/></td>     
              </tr>                  
              <tr>
                  <td class="f"><label id="lbldocto_anexo"/></td>
                  <td class="e"><input type="file" id="docto_anexo_contrato" name="file"/><a href="#" id="link_file_anexo_contrato" class="verarchivo_anexo_contrato"></a></td>  
              </tr>
              <tr class="renglon_sistema">
                  <td>idContrato:</td>
              ...
              <tr class="renglon_sistema">                                              
                  <td  class="boton_dialog"><a href="#" class ="posicion_boton_accion_anexo_contrato">ACEPTAR</a></td>                  
                  <td  class="boton_dialog"><a href="#" class ="posicion_boton_cancelar_anexo_contrato">CANCELAR</a></td>                  
              </tr>
          </tbody>
       </table>
    </div>     
