<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_contratista.aspx.vb" Inherits="Admin_procesos_consultar_contratista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Razón Social del Contratista:</label><input type="text" name="contratista" id="txtnom_contratista_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_contratista"><== Buscar CONTRATISTA ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_contratista"><== Alta CONTRATISTA ==></a><br/><br/>        
       ...
       <table class="t_modulo">
          <tbody> 
              ...
              <tr>
                  ...
                  <td class="e" colspan="3"><input type="text" name="razon_soc" id="txtrazon_soc_cont" size="120" maxlength="50"/></td>
              </tr>             
              <tr>
                  <td class="f">Representante Legal:</td>
                  <td class="e" colspan="3"><input type="text" name="repres_legal" id="txtrepres_legal" size="120" maxlength="120"/></td>                  
              </tr>
              <tr>
                  <td class="f">Calle:</td>
                  <td class="e" colspan="3"><input type="text" name="calle_contratista" id="txtcalle_cont" size="120" maxlength="120"/></td>
                  
              </tr>
              <tr>
                  <td class="f">Colonia:</td>
                  <td class="e" colspan="3"><input type="text" name="colonia_cont" id="txtcolonia_cont" size="120" maxlength="120"/></td>                  
              </tr>
              <tr>
                  <td class="f">Ciudad:</td>
                  <td class="e"><input type="text" name="ciudad_cont" id="txtciudad_cont" size="30" maxlength="30"/></td>
                  <td class="f">Estado:</td>
                  <td class="e"><input type="text" name="estado_cont" id="txtestado_cont" size="30" maxlength="30"/></td>
              </tr>
              <tr>                  
                  <td  class="f">No.Oficial:</td>
                  <td  class="e"><input type="text" name="NoOficial" id="txtnum_ofic_cont" size="12" maxlength="12"/></td>
                  <td  class="f">Código Postal:</td>
                  <td  class="e"><input type="text" name="codigo_postal" id="txtcp_cont" size="12" maxlength="12"/></td>
              </tr>              
               <tr>
                  <td class="f">RFC:</td>
                  <td class="e"><input type="text" name="rfc" id="txt_rfc_cont" size="13" maxlength="13"/></td>
                  <td class="f">No.Padrón_Proveedores:</td>
                  <td class="e"><input type="text" name="num_prov" id="txt_num_prov" size="30" maxlength="30"/></td>
              </tr>
              <tr>
                  <td class="f">No.Reg_Público:</td>
                  <td class="e"><input type="text" name="reg_pub" id="txtreg_pub_cont" size="20" maxlength="30"/></td>
                  <td class="f">No. Reg. IMSS</td>
                   <td class="e"><input type="text" name="nom_cont" id="txtnom_cont" size="20" maxlength="20"/></td>
              </tr>
              <tr>
                  <td class="f">Teléfono 1:</td>
                  <td class="e"><input type="text" name="telefono1" id="txttel1_cont" size="12" maxlength="12"/></td>              
                  <td class="f">Teléfono 2:</td>
                  <td class="e"><input type="text" name="telefono2" id="txttel2_cont" size="12" maxlength="12"/></td>
              </tr>
              <tr>
                  <td class="f">Correo Electrónico:</td>
                  <td colspan="3" class="e"><input type="text" name="reg_pub" id="txtemail_cont" size="120" maxlength="200"/></td>                  
              </tr>              
              ...
              <tr>    
                  ...
                  <td  colspan="2" class="boton_dialog"><a href="#" class ="posicion_boton_accion_contratista">ACEPTAR</a></td>
                  
                  <td  colspan="2" class="boton_dialog"><a href="#" class ="posicion_boton_cancelar_contratista">CANCELAR</a></td>
