<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="edo_cta_fte_cv.aspx.vb"
    Inherits="Admin_procesos_edo_cta_fte_cv" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <b>Cooperador:<input type="text" name="Cooperador:" id="txtcoop" style="width:80px" />&nbsp &nbsp Nombre de
                Cooperador:<input type="text" name="NomCoop" id="txtnomcoop" style="width:250px" />&nbsp &nbsp Frente:
                </><input type="text" name="fid" id="txtfid" style="width:50px" /> </b><br /><br />
            <table id="grid"></table>
            ...
            <div id="boxes">
                <div id="dialogodet" class="window">
                    ...
                    <div class="datos" id="bodypresup">
                        <label for="name">*Fecha de impresión del Dcto. Determinante:</label><input type="text"
                            name="fec_imp_dcto_det" id="txt_fec_imp_dcto_det" size="10" /><br /><br />
                        <label for="name">*Fecha de entrega del Dcto. al notificador:</label><input type="text"
                            name="fec_ent_dcto_det" id="txt_fec_ent_dcto_det" size="10" /><br /><br />
                        <label for="name">*Fecha de notificación del Dcto. Determinante:</label><input type="text"
                            name="fec_notif_det" id="txt_fec_notif_det" size="10" /><br /><br />
                        <label for="name">*Documento Determinante:</label><input type="file" id="filedet" name="file" />
                        <a href="#" id="archivo" class="verarchivo" />
                    </div>
                    <div class="botonesA" id="botonesC">
                        <p style="text-align:right"><a href="#"
                                class="posicion_boton_accion_det">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                                class="posicion_boton_cancelar_det">Cancelar</a></p>
                    </div>
                </div>
                <div id="mask"></div>
            </div>
