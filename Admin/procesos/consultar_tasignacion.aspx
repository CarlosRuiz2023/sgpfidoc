<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master"
    CodeFile="consultar_tasignacion.aspx.vb" Inherits="Admin_procesos_consultar_tasignacion" %>
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <label>Tipo de Asignacion:</label><input type="text" name="tipo_asignacion" id="txttipo_asignacion_q"
            style="width:250px" maxlength="120" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#"
            class="buscar_tipo_asignacion">
            <== Buscar Tipo de Asignacion==>
        </a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tipo_asignacion">
            <== Alta Tipo Asignacion==>
        </a><br /><br />
        ...
        <div id="boxes">
            <div id="dialogo_tasig" class="window">
                ...
                <div class="datos" id="bodyAccion">
                    <label for="name" id="lbletiqueta_tasignacion">*Nombre de Tipo de Asignación:</label><input
                        type="text" name="Etiqueta Tipo de Asignación" id="txtetiqueta_tasignacion"
                        size="60" /><br /><br />
                    <label for="name" id="lbldescripcion_tasignacion">*Descripción del Tipo de Asignación:</label><input
                        type="text" name="Descripcion del Tipo de Asignación" id="txtdescripcion_tasignacion"
                        size="120" /><br /><br />
                </div>
                <div class="botonesA" id="botonesC">
                    <p style="text-align:right"><a href="#"
                            class="posicion_boton_accion_tipo_asignacion">Aceptar</a>&nbsp&nbsp&nbsp<a href="#"
                            class="posicion_boton_cancelar_tipo_asignacion">Cancelar</a></p>
                </div>
            </div>
            <div id="mask"></div>
        </div>
