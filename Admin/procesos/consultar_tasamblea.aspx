<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="consultar_tasamblea.aspx.vb" Inherits="Admin_procesos_consultar_tasamblea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <label>Tipo de Asamblea:</label><input type="text" name="tipo_asamblea" id="txttipo_asamblea_q" style="width:250px" maxlength ="120"/>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="buscar_tipo_asamblea"><== Buscar Tipo de Asamblea ==></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="#" class="alta_tipo_asamblea"><== Alta Tipo Asamblea ==></a><br/><br/>        
...
<div id="boxes">        
    <div id="dialogo_tasamblea" class="window"> 
       ...
       <div class="datos" id="bodyAccion">                  
          <label for="name" id="lbletiqueta_asamblea">*Nombre de Tipo de Asamblea:</label><input type="text" name="Etiqueta Tipo de Asamblea" id="txtetiqueta_tipo_asamblea" size="60"/><br/><br/>          
          <label for="name" id="lbldescripcion_asamblea">*Descripción del Tipo de Asamblea:</label><input type="text" name="Descripcion del Tipo de Asamblea" id="txtdescripcion_tipo_asamblea" size="120"/><br/><br/>          
       </div>                  
       <div class="botonesA" id="botonesC">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_tipo_asamblea">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_tipo_asamblea">Cancelar</a></p>                
       </div>
    </div>     
    <div id="mask"></div>
 </div>
