<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="edo_cta_fte_gral.aspx.vb"
    Inherits="Admin_procesos_edo_cta_fte_gral" %>
    <%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <b>Cooperador:<input type="text" name="Cooperador:" id="txtcoop" style="width:80px" />&nbsp &nbsp Nombre de
                ...
                </><input type="text" name="fid" id="txtfid" style="width:50px" /></b>&nbsp &nbsp &nbsp &nbsp<a href="#"
                class="posicion_boton_consultar_edo">CONSULTAR ESTADO DE CUENTA</a><br /><br />
            <table id="grid"></table>
