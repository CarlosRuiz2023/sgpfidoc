<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage.master" CodeFile="obras.aspx.vb" Inherits="Admin_procesos_obras" Culture="Auto" UICulture="Auto"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <b>Nombre de Calle:<input type="text" name="Calle" id="txtnomcalle" style="width:250px"/>&nbsp &nbsp No. Obra:</><input type="text" name="oid" id="txtoid" style="width:50px" /> &nbsp &nbsp Obra_SIFIDOC:</><input type="text" name="obra_s"  maxlength="10" id="obra_s" style="width:100px" /></b><br/><br/>        
 ...
 <div id="boxes">    
    <div id="dialogoObra" class="window"> 
       ...
       <div class="datos" id="bodyObra">          
          <br/><br/>
           &nbsp&nbsp&nbsp<label for="name">*Obra:</label><input type="text" name="txtobra" id="txtobra" size="10"/>&nbsp&nbsp&nbsp&nbsp<a href="#" class="geom_obra">Ver obras >>></a><br/><br/>          
          <label for="name">*NoObra:</label><input type="text" name="noobra" id="txtnoobra" size="10" maxlength="10"/><br/>
          <label for="name">NoObra2:</label><input type="text" name="noobra2" id="txtnoobra2" size="10" maxlength="10"/><br/>
          <label for="name">NoObra3:</label><input type="text" name="noobra3" id="txtnoobra3" size="10" maxlength="10"/> <br/><br/>          
          <label for="name">*COLONIA:</label><select name="colonia" id="colonia"></select><br/><br/>                 
          <label for="name">*CALLE A PAVIMENTAR:</label><select name="calle" id="calle"></select><br/><br/> 
          <label for="name">*TRAMO:</label><input type="text" name="tramo" id="tramo" size="120"/><br/><br/>
          <label for="name">*Estatus Obra:</label><select name="estatusobra" id="estatusobra"></select>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<label for="name">Cuenta contable:</label><input type="text" name="ctacontable" id="txtctacontable" size="25" maxlength="25"/><br/><br/><br/>
          <label for="name">*Fec_Inic_Pago (dd/mm/aaaa):</label><input type="text" name="fecinipag" id="fecinipag" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/>&nbsp&nbsp&nbsp
          <label for="name">*No.Pagos:</label><input type="text" name="nopagos" id="txtnopagos" size="10" maxlength="10"/>&nbsp&nbsp&nbsp<label id="lblfecvenc" for="name">*Fecha Venc. (dd/mm/aaaa):</label><br/><br/>
          <label for="name">*Fecha_Recaudación (dd/mm/aaaa):</label><input type="text" name="fecrec" id="txtfecrec" size="10" maxlength="10"onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>
          <label for="name">*Fecha_Proceso (dd/mm/aaaa):</label><input type="text" name="fecproc" id="txtfecproc1" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>          
          <label for="name">*Fecha_Cobranza (dd/mm/aaaa):</label><input type="text" name="feccob" id="txtfeccob" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>                    
       </div>                  
       <div class="botonesA" id="botonesA">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_obra">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_obra">Cancelar</a></p>                
       </div>
    </div>
    <div id="dialogoPub" class="window"> 
       ...
       <div class="datos" id="bodyPub">                            
          <label for="name" id="fec">Fecha de Publicación:</label>&nbsp&nbsp<input type="text" name="pub" id="txtfecpub" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>
          <label for="name" id="docpub">Documento Publicación:</label>&nbsp&nbsp<input type="file" id="filepub" name="file"/> <a href="#" id="archivo2" class="verarchivo"></a> 
       </div>                  
       <div class="botonesA" id="botonesB">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_pub">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_pub">Cancelar</a></p>                
       </div>
    </div>           
    <div id="dialogoprocobra" class="window"> 
       ...
       <div class="datos" id="bodyestatusproc">                            
          <label for="name" id="lblfecproc">Fecha inicio de proceso la obra:</label>&nbsp&nbsp<input type="text" name="pub" id="txtfecproc" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>          
       </div>                  
       <div class="botonesA" id="botonesprocesoobra">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_procobra">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_procobra">Cancelar</a></p>                
       </div>
    </div>           
    <div id="dialogoentregaobra" class="window"> 
       ...
       <div class="datos" id="bodyentregaobra">                            
          <label for="name" id="lblfecpav2">Fecha entrega de pavimentación de la obra:</label>&nbsp&nbsp<input type="text" name="entregaobra" id="txtentregaobra" size="10" maxlength="10" onkeyup = "this.value=formateafecha(this.value);"/><br/><br/>          
          <label for="name" id="lbldocentobra">Documento Entrega Obra:</label>&nbsp&nbsp<input type="file" id="fileentobra" name="file"/> <a href="#" id="archivo3" class="verarchivo"/> 
       </div>                  
       <div class="botonesB" id="botonesentregaobra">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_entregaobra">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_entregaobra">Cancelar</a></p>                
       </div>
    </div>       
     <div id="dialogopresup" class="window"> 
       ...
       <div class="datos" id="bodypresup">
          <label for="name">    Programa        ||        Descripción        ||        Costo_Mto._Lineal          ||           Costo_Total_Obra </label><br/>
           <select name="programa" id="lstprogs"></select><br/><br/> 
          <label for="name">Gastos_Admvos:</label><input type="text" name="gastosadmvos" id="txtgtosadmvos" size="10"/><br/><br/>   
          <label for="name">Folio_Calidad:</label><input type="text" name="foliocalidad" id="txtfoliocalidad" size="10"/><br/><br/>   
          <label for="name">mts2_arroyo:</label><input type="text" name="mts2arroyo" id="txtmts2arroyo" size="10"/><br/><br/>   
          <label for="name">mts2_banqueta:</label><input type="text" name="mts2banqueta" id="txtmts2banqueta" size="10"/><br/><br/>   
          <label for="name">Derrama_Vecinos:</label><input type="text" name="derramavecinos" id="txtderramavecinos" size="10"/><br/><br/>   
          <label for="name">Derrama_EU:</label><input type="text" name="derramaeu" id="txtderramaeu" size="10"/><br/><br/>   
          <label for="name">Metros_Arroyo:</label><input type="text" name="mtsarroyo" id="txtmtsarroyo" size="10"/><br/><br/>
          <label for="name">Metros_Banqueta:</label><input type="text" name="mtsbanqueta" id="txtbanqueta" size="10"/><br/><br/>
          <label for="name">Metros_Sección:</label><input type="text" name="mtsseccion" id="txtmtsseccion" size="10"/><br/><br/>
          <label for="name">*Costo metro lineal.:</label><input type="text" name="costomtolineal" id="txtcostomtolineal" size="10"/><br/><br/>
          <label for="name">*Costo de Obra Total:</label><input type="text" name="costoobratotal" id="txtctoobratotal" size="15"/><br/><br/>
          <label for="name">*Programa:</label><select name="programa" id="lstprograma"></select><br/><br/>            
          <label for="name">*Documento:</label><input type="file" id="filepresup" name="file"/> <a href="#" id="archivopresup" class="verarchivo"/>                    
       </div>                  
     ...
     <div id="dialogoconv" class="window"> 
       <div id="tituloconv"> 
         ...
         Calle:<label for="calle" id="lblcalleconv"></label>&nbsp&nbsp<label for="nooficial" id="lblnooficialconv"></label><br/>                                       
       ...
       <div class="datos" id="bodyconvenio">          
          ...
          <label for="name">*Número de pagos:</label><input type="number" id="txtnumpagosconv" min="1" max="18"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); if (this.value > 18) this.value = 18; calculafecvencconv(this.value) " maxLength="2"/><label id="pagomensual"></label><br/><br/>   
          <label for="name">*Fecha de vencimiento:</label><label id="lblfecvencconv"></label><br/><br/>   
          <label for="name">*Convenio firmado:</label><input type="file" id="fileconvenio" name="file"/> <a href="#" id="aconvenio" class="verconvenio"/><br/>                    
          <table>
          <tr>             
             <th></th>
             <th></th>
          ...
          <tr>
             ...
             <td class="auto-style100"><input type="number" id="txtdesctorecargo" min="1" max="50"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); if (this.value > 50) this.value = 50; calculadesctorecargo(this.value) " maxLength="2"/>&nbsp&nbsp%</td>
          </tr>
          <tr>
             <td class="auto-style100">Recargo por convenio:</td>
             <td class="auto-style102"><label id="lblrecargoconv"></label></td>
             <td class="auto-style100"></td>
             <td class="auto-style100"><input type="number" id="txtrecargoconv" min="1" max="5"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); if (this.value > 5) this.value = 1.13; calcularecargoconv(this.value) " maxLength="4"/>&nbsp&nbsp%</td>
          </tr>
          <tr>
             <td class="auto-style100"></td>
             <td class="auto-style100"></td>
       ...
       <div class="botonesA" id="botonesconv">
          <p style="text-align:right"><a href="#" class ="posicion_boton_accion_convenio">Aceptar</a>&nbsp&nbsp&nbsp<a href="#" class="posicion_boton_cancelar_convenio">Cancelar</a></p>                
       </div>
    </div>            
