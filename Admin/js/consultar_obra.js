        ...
        return $.ajax({
            ...
            success: function (data) {
                if (data.d != null) {
                    ...
                    const obr_clv = partes[2]; // El "736" está en el segundo elemento (índice 1)

                    //TODO: Se agrego el WS para enviar directamente la obra a e-translados.

                    // Construir el objeto de datos correctamente
                    const segundaPeticionData = {
                        pPageSize: 20,
                        pCurrentPage: 1,
                        pSortColumn: "b.obr_clv_int",
                        pSortOrder: "asc",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.d != null) {       
                                ...
                                const obr_tramo = data.d.Items[0].row[4];
                                const obr_fecha = data.d.Items[0].row[14];
                                const col_nom = data.d.Items[0].row[3];
                                const obr_programa = data.d.Items[0].row[52];
                                const obr_fecvenp = data.d.Items[0].row[15];
