...
(function ($) {
    ...
    $.fn.excelexportjs = function (options) {
        ...
        $settings = $.extend({}, $logins, options);
        ...
        function Export(htmltable) {
            ...
            if (isBrowserIE()) {
                ...
                var excelFile = "<html xml:lang=" + $logins.locale + " xmlns:o='urn:schemas-microsoft-com:office:office' xmlns:x='urn:schemas-microsoft-com:office:excel' xmlns='http://www.w3.org/TR/REC-html40'>";
                excelFile += "<head>";
                excelFile += '<meta http-equiv="Content-type" content="text/html;charset=' + $logins.encoding + '" />';
