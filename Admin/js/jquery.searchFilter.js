...
jQuery.fn.searchFilter = function (fields, options) {
    ...
    function SearchFilter(jQ, fields, options) {
        ...
        if (fields != null) { // type coercion matches undefined as well as null
            ...
            <div class='ui-closer ui-state-login ui-corner-all ui-helper-clearfix' style='float: right;'>\
            ...
            <td class='ops'></td>\
            <td class='data'></td>\
            <td><div class='ui-del ui-state-login ui-corner-all'><span class='ui-icon ui-icon-minus'></span></div></td>\
            <td><div class='ui-add ui-state-login ui-corner-all'><span class='ui-icon ui-icon-plus'></span></div></td>\
            </tr>\
            <tr>\
            ...
            <tr>\
            <td colspan='3'>\
            <span class='ui-reset ui-state-login ui-corner-all' style='display: inline-block; float: left;'><span class='ui-icon ui-icon-arrowreturnthick-1-w' style='float: left;'></span><span style='line-height: 18px; padding: 0 7px 0 3px;'>" + opts.resetText + "</span></span>\
            <span class='ui-search ui-state-login ui-corner-all' style='display: inline-block; float: right;'><span class='ui-icon ui-icon-search' style='float: left;'></span><span style='line-height: 18px; padding: 0 7px 0 3px;'>" + opts.searchText + "</span></span>\
            <span class='matchText'>" + opts.matchText + "</span> \
            " + gOps_html + " \
            <span class='rulesText'>" + opts.rulesText + "</span>\
            </td>\
            <td>&nbsp;</td>\
            <td><div class='ui-add-last ui-state-login ui-corner-all'><span class='ui-icon ui-icon-plusthick'></span></div></td>\
            </tr>\
            </tfoot>\
            </table>\
            ");
            ...
            jQ.html("").addClass("ui-searchFilter").append("<div class='ui-widget-overlay' style='z-index: -1'>&#160;</div><table class='ui-widget-content ui-corner-all'><thead><tr><td colspan='5' class='ui-widget-header ui-corner-all' style='line-height: 18px;'><div class='ui-closer ui-state-login ui-corner-all ui-helper-clearfix' style='float: right;'><span class='ui-icon ui-icon-close'></span></div>" + opts.windowTitle + "</td></tr></thead><tbody><tr class='sf'><td class='fields'></td><td class='ops'></td><td class='data'></td><td><div class='ui-del ui-state-login ui-corner-all'><span class='ui-icon ui-icon-minus'></span></div></td><td><div class='ui-add ui-state-login ui-corner-all'><span class='ui-icon ui-icon-plus'></span></div></td></tr><tr><td colspan='5' class='divider'><hr class='ui-widget-content' style='margin:1px'/></td></tr></tbody><tfoot><tr><td colspan='3'><span class='ui-reset ui-state-login ui-corner-all' style='display: inline-block; float: left;'><span class='ui-icon ui-icon-arrowreturnthick-1-w' style='float: left;'></span><span style='line-height: 18px; padding: 0 7px 0 3px;'>" + opts.resetText + "</span></span><span class='ui-search ui-state-login ui-corner-all' style='display: inline-block; float: right;'><span class='ui-icon ui-icon-search' style='float: left;'></span><span style='line-height: 18px; padding: 0 7px 0 3px;'>" + opts.searchText + "</span></span><span class='matchText'>" + opts.matchText + "</span> " + gOps_html + " <span class='rulesText'>" + opts.rulesText + "</span></td><td>&#160;</td><td><div class='ui-add-last ui-state-login ui-corner-all'><span class='ui-icon ui-icon-plusthick'></span></div></td></tr></tfoot></table>");
            ...
            // generate the logins
            var login_ops_html = "";
            jQuery.each(opts.operators, function () { login_ops_html += buildOpt(this.op, this.text); });
            login_ops_html = buildSel("login", login_ops_html, true);
            jOps.append(login_ops_html);
            var login_data_html = "<input type='text' class='login' style='display:none;' />";
            jData.append(login_data_html);
            ...
            if (has_custom_ops) jFSelect.change(function (e) {
                ...
                if (jElem[0] == null) jElem = td.find(".default"); // if there's not an element for that field, use the login one
            ...
            // bind events
            jQ.find(".ui-state-login").hover(hover, hover).mousedown(active).mouseup(active); // add hover/active effects to all buttons
            ...
            jQ.find(".ui-add").click(function (e) {
                ...
                newRow.find(".ui-state-login").removeClass("ui-state-hover ui-state-active");
                if (opts.clone) {
            ...
            jQ.find(".ui-reset").click(function (e, op) {
                ...
                ui.find("select[name='groupOp']")[0].selectedIndex = 0; // changes the op back to the login one
                opts.onReset(op);
                return false;
            });
...
/* This property contains the login options */
