...
/**
 * @license Guriddo jqGrid JS 5.3.1 (201-03-12)
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.rowList.length >0){
				str = "<td dir=\""+dir+"\">";
				str +="<select "+getstyle(stylemodule, 'pgSelectBox', false, 'ui-pg-selbox')+" size=\"1\" role=\"listbox\" title=\""+($.jgrid.getRegional(ts,"logins.pgrecs",ts.p.pgrecs) || "")+ "\">";
				var strnm;
