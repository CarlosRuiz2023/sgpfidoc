...
#Region "Metodos"
    ...
    Public Shared Function Consulta_Estatus(ByVal objEstatus As clsEstatusSol) As DataTable
        ...
        Activo.Value = objEstatus._Activo
        ...
        Return conn.EjecutarConsulta("SP_EstatusSol", params)
    End Function

    Public Shared Function Insertar(ByVal objEstatus As clsEstatusSol) As Boolean
        Dim params = New List(Of SqlParameter)
        ...
        '-------------------------Invoca la función para ejecutar el SP
        Return conn.EjecutarOperacion("SP_EstatusSol", params)
    End Function
