Public Class JQGridJsonResponseCoopsCob
...
#End Region
    ...
    Public Sub JQGridJsonResponseCoopsCob(pPageCount As Integer, pCurrentPage As Integer, pRecordCount As Integer, coopfpocs As List(Of clsFrentePredioObraCoop))
