Public Class clsContratoAnexos
    ...
    Private _cestatus_contrato As Integer = 0
    ...
    Private _cactivo_anexo_contrato As Integer = 0
...
#Region "Propiedades"
    ...
    Public Property docto_contrato() As String
        ...
        End Set
    End Property
    Public Property cestatus_contrato() As Integer
        Get
            Return _cestatus_contrato
        End Get
        Set(ByVal Value As Integer)
            _cestatus_contrato = Value
        End Set
    End Property
    ...
    Public Property valor_param4() As Double
        ...
        End Set
    End Property
    Public Property cactivo_anexo_contrato() As Integer
        Get
            Return _cactivo_anexo_contrato
        End Get
        Set(ByVal Value As Integer)
            _cactivo_anexo_contrato = Value
        End Set
    End Property
