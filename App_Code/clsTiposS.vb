...
#Region "Metodos"
    ...
    Public Shared Function Consulta_TiposS(ByVal objTipoS As clsTiposS) As DataTable
        ...
        Return conn.EjecutarConsulta("SP_TiposUsoS", params)
    End Function

    Public Shared Function Insertar(ByVal objTipoS As clsTiposS) As Boolean
        Dim params = New List(Of SqlParameter)
        ...
        '-------------------------Invoca la función para ejecutar el SP
        Return conn.EjecutarOperacion("SP_TiposUsoS", params)
    End Function
