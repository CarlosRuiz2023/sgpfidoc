...
#Region "variables privadas"
    ...
    Private _EstatusDescrip As String = String.Empty
    ...
    Private _MetrosLong As Double = 0
    Private _PorcentajeCapt As Double = 0
    Private _NumDocs As Integer = 0
...
#Region "Propiedades"
    ...
    Public Property Calle() As String
        ...
        End Set
    End Property
    Public Property EstatusDescrip() As String
        Get
            Return _EstatusDescrip
        End Get
        Set(ByVal Value As String)
            _EstatusDescrip = Value
        End Set
    End Property
    ...
    Public Property ubic() As Integer
        ...
        End Set
    End Property
    Public Property MetrosLong() As Double
        Get
            Return _MetrosLong
        End Get
        ...
        End Set
    End Property
    Public Property PorcentajeCapt() As Double
        Get
            Return _PorcentajeCapt
        End Get
        Set(ByVal Value As Double)
            _PorcentajeCapt = Value
        End Set
    End Property
...
#Region "Metodos"
    Public Shared Function Consulta(ByVal objSol As clsSolicitud) As DataTable
    ...
    Public Shared Function ActualizarCalles(ByVal objSol As clsSolicitud) As Boolean
    ...
    Public Shared Function Insertar(ByVal objSol As clsSolicitud) As Boolean
        Dim params = New List(Of SqlParameter)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function Consulta_Solicitudes(ByVal objSol As clsSolicitud, ByRef tbl As DataTable) As Boolean
        Dim params = New List(Of SqlParameter)
